...
$btnUpdateDetails = new Button("btnUpdateDetails", "btnUpdateDetails", "Update Details");
...
if ($fproc->IsPostBack) {
    ...
    if ($fproc->GetPostVar('btnUpdateRewardOffer') == 'Update') {
    ...
    if (($btnUpdateDetails->SubmittedValue) == 'Update Details') {
