...
//    public static function retMsgResetPin($module, $txtcardnumber, $status, $errorCode, $transMsg) {
//        $module == 'ResetPin';
//        return array('ResetPin' => array('CardNumber' => $txtcardnumber, 'Status' => $status, 'ErrorCode' => $errorCode, 'ReturnMessage' => $transMsg));
//
//    }
