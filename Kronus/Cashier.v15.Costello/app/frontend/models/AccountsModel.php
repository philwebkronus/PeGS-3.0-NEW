...
//    }
    ...
    */
    ...
    public function getVirtualCashier($siteid){
        $sql = 'SELECT acct.AID FROM accounts acct INNER JOIN siteaccounts sa ON acct.AID = sa.AID WHERE sa.SiteID = :site_id AND acct.AccountTypeiD = 15 and sa.Status = 1';
    ...
    public function checkCashierSiteClassification($zusername ) {
        $sql = 'SELECT s.SiteClassificationID FROM accounts a
