...
class CommonUBRedeem {
    ...
    public function redeemForceT($login_pwd, $terminal_id, $site_id, $bcf, $service_id, $amount, $paymentType, $acct_id, $loyalty_card, $mid = '', $userMode = '', $casinoUsername = '', $casinoPassword = '', $casinoServiceID = '') {
        Mirage::loadComponents('CasinoApiUB');
        Mirage::loadModels(array('TerminalsModel', 'EgmSessionsModel', 'CommonTransactionsModel', 'StackerSummaryModel',
            'PendingUserTransactionCountModel', 'ForceTRedemptions'));
        ...
        list ($terminal_balance, $service_name, $terminalSessionsModel,
                $transReqLogsModel, $redeemable_amount, $casinoApiHandler, $mgaccount, $currentbet) = $casinoApi->getBalanceForceT($terminal_id, $site_id, 'W', $casinoServiceID, $acct_id, $casinoUsername, $casinoPassword, $login_pwd);

        $forcetredemptionid = $ForceTRedemptions->insert($site_id, $amount, $service_id, $mid, $loyalty_card, $userMode, 0, $acct_id);

        $tracking1 = "FT" . $forcetredemptionid;
        $tracking2 = 'W';
        $tracking3 = '';
        $tracking4 = $site_id;
        $event_id = Mirage::app()->param['mgcapi_event_id'][2]; //Event ID for Withdraw
        ...
        /*         * ********************** WITHDRAW *********************************** */
        $resultwithdraw = $casinoApiHandler->Withdraw($casinoUsername, $amount, $tracking1, $tracking2, $tracking3, $tracking4, $casinoPassword, $event_id, $transaction_id);
        ...
        if (is_null($resultwithdraw)) {
            ...
            $ForceTRedemptions->updatePendingTerminalCount(2, '', $apiresult, $forcetredemptionid);

            $message = 'Error: Request denied. Please try again.';
            CasinoApiUB::throwError($message);
        } else {

            $ForceTRedemptions->updatePendingTerminalCount(1, $transrefid, $apiresult, $forcetredemptionid);
