...
class CommonUBStartSession {
     ...
     * @return array 
     */
    public function start($terminal_id, $site_id, $trans_type, $paymentType, $service_id, $bcf, $initial_deposit, $acctid, $loyalty_card, $voucher_code = '', $trackingid = '', $casinoUsername = '', $casinoPassword = '', $casinoHashedPassword = '', $casinoServiceID = '', $mid = '', $userMode = '', $traceNumber = '', $referenceNumber = '', $locatorname = '') {
        ...
        Mirage::loadModels(array('TerminalsModel', 'EgmSessionsModel', 'SiteBalanceModel', 'CommonTransactionsModel',
            'PendingUserTransactionCountModel', 'RefServicesModel', 'BankTransactionLogsModel'));
        ...
        list($terminal_balance, $service_name, $terminalSessionsModel,
                $transReqLogsModel, $redeemable_amount, $casinoApiHandler, $mgaccount) = $casinoApi->getBalanceUB($terminal_id, $site_id, 'D', $casinoServiceID, $acct_id = '', $casinoUsername, $casinoPassword);
...
//        $tracking4 = $site_id;
        ...
        if ($terminaltype !== 2 && $initial_deposit > 0) {
            ...
            $transReqLogsModel->updateTransReqLogDueZeroBal($terminal_id, $site_id, 'D', $trans_req_log_last_id);
