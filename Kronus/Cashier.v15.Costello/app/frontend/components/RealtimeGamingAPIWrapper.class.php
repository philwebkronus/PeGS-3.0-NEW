...
class RealtimeGamingAPIWrapper
{
    ...
    public function Deposit( $login, $amount, $tracking1 = '', $tracking2 = '', $tracking3 = '', $tracking4 = '' , $password = '')
    {
    ...
    public function Withdraw( $login, $amount, $tracking1 = '', $tracking2 = '', $tracking3 = '', $tracking4 = '', $password = '' )
    {
        $GetPIDFromLoginResult = $this->_GetPIDFromLogin( $login );
