...
//        $login = '';
        ...
        $siteAmountInfo = $sitesModel->getSiteAmountInfo($this->site_id);
        $siteClassification = $sitesModel->getSiteClassification($this->site_id);
        $eBingoDenomination = json_encode(Mirage::app()->param['eBingoReloadDenom']);
        $eBingoDivisibleBy = Mirage::app()->param['eBingoDivisibleBy'];
        $eBingoMinDeposit = Mirage::app()->param['eBingoDivisibleBy'];
        $eBingoMaxDeposit = Mirage::app()->param['eBingoMaxDeposit'];
        ...
        $this->renderPartial('terminal_reload_hk', array('startSessionFormModel' => $startSessionFormModel, 'terminals' => $terminals,
            ...
            'eBingoDenomination' => $eBingoDenomination, 'eBingoDivisibleBy' => $eBingoDivisibleBy, 'eBingoMinDeposit' => $eBingoMinDeposit, 'eBingoMaxDeposit' => $eBingoMaxDeposit
        ));
    }
...
//        }
        ...
        $siteAmountInfo = $sitesModel->getSiteAmountInfo($this->site_id);
        $eBingoDenomination = Mirage::app()->param['eBingoReloadDenom'];
        $eBingoDivisibleBy = Mirage::app()->param['eBingoDivisibleBy'];
        $eBingoMinDeposit = Mirage::app()->param['eBingoDivisibleBy'];
        $eBingoMaxDeposit = Mirage::app()->param['eBingoMaxDeposit'];
        ...
        $this->renderPartial('terminal_reload', array('startSessionFormModel' => $startSessionFormModel,
            ...
            'eBingoDenomination' => $eBingoDenomination, 'casinoUserMode' => $casinoUserMode, 'eBingoDivisibleBy' => $eBingoDivisibleBy, 'eBingoMinDeposit' => $eBingoMinDeposit, 'eBingoMaxDeposit' => $eBingoMaxDeposit
        ));
    }
    ...
    public function startSessionClickAction() {
        ...
        $this->renderPartial('terminal_startsession', array('startSession' => $startSessionFormModel,
            'denomination' => $denomination, 'casinos' => $casinos, 'is_vip' => $is_vip, 'tcode' => $tcode, 'usermode' => $usermode, 'siteAmountInfo' => $siteAmountInfo, 'eBingoDenomination' => $eBingoDenomination, 'eBingoDivisibleBy' => $eBingoDivisibleBy,
            'eBingoMinDeposit' => $eBingoMinDeposit, 'eBingoMaxDeposit' => $eBingoMaxDeposit
        ));
    }
    ...
    public function callUnlockAction() {
        ...
        $terminals = $terminalsModel->getAllActiveForceTTerminals($this->site_id, $this->len);
        if (isset($_POST['UnlockTerminalFormModel'])) {
            if (isset($_POST['UnlockTerminalFormModel']['loyalty_card']) && isset($_POST['sitecode']) && isset($_POST['tcode'])) {
