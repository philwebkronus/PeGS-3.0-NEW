...
<script type="text/javascript">
            ...
            if(validate == true)
            {
               ...
               getdetailsbyID(value); //call function for transaction detailsddd
                ...
                jQuery("#transsummary").jqGrid({
                        ...
                        datatype: "json",
                        colNames:['POS Account No', 'Terminal Code', 'Deposit', 'Reload', 'Withdraw','Date Started', 'Date Ended', 'Created By'],
                        colModel:[
    ...
    function getdetailsbyID(value)
    {
        ...
        jQuery("#transdetails").jqGrid({
                    ...
                    datatype: "json",
                    colNames:['POS Account No', 'Terminal Code', 'Transaction Type', 'Service Name', 'Amount','Transaction Date', 'Created By','Status'],
                    colModel:[
                            {name:'POSAccountNo',index:'POSAccountNo',align:'center', width: 100},
                            {name:'TerminalCode',index:'TerminalCode', align: 'center', width: 65},
                            {name:'TransactionType',index:'TransactionType', align: 'left', width: 100},
                            {name:'ServiceName',index:'ServiceName', align: 'center', width: 130},
                            {name:'Amount',index:'Amount', align: 'right', width: 100},
                            {name:'DateCreated',index:'DateCreated', align: 'center', width: 170},
