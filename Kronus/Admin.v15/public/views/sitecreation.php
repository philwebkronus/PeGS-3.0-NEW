...
<!--                <tr>
                ...
                <!--Site Tagging 1 for Non Platinum Site and 2 for Platinum Site-->
                <tr>
                    <td>Site Classfication</td>
                    <td>
                       Platinum<input type="radio" id="platinum" name="siteClass" value="2" />
                       Non - Platinum<input type="radio" id="nonplatinum" name="siteClass" value="1" checked />
                    </td>
                </tr>
                <tr>
                    <td>isTestSite</td>
