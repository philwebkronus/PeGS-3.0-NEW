...
define ( 'RTGCerts_DIR', 'C://Apache24/htdocs/Kronus_UB/admin.abbott.version/public/views/sys/config/RTGClientCerts/'); //staging
...
define('referrer',"http://localhost/Kronus_UB/admin.v15/public/views/login.php");
$terminalcode = "ICSA-";
...
$cardinfo = 'http://localhost/membership.rewards.v02/API/cardinquiry.php'; //for getting membership card information
...
$_ServiceAPI[19] = 'https://202.44.103.53/ILMCB6UOP7SXXCAQUC88/processor/processorapi/cashier.asmx'; 
...
$_PlayerAPI[19] = 'https://202.44.103.53/ILMCB6UOP7SXXCAQUC88/RTG.Services/Player.svc?wsdl';
...
$_LobbyAPI[14] = 'https://202.44.103.53/ILMCB6UOP7SXXCAQUC88/CasinoAPI/lobby.asmx';
...
$Pcws = array(
    ...
    'systemcode' => '4996816',
    'resetpin' => '192.168.41.80/pcws/index.php/pcws/changepin',
    'forcelogout' => '192.168.41.80/pcws/index.php/pcws/forcelogout', 
...
$LogPaths['BTAMPAPI'] = $BTAMPAPIlogtah;
