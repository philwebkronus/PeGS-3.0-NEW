          ...
          $(document).ready(function()
          {
                ...
                jQuery("#cmbservices").live('change', function(){
                   ...
                   $.ajax({
                       url : url,
                       type : 'post',
                       data : {page : function(){ return 'GetServiceGroup'; },
                               serviceid : function() {return $('#cmbservices').find("option:selected").val(); }
                              },
                       dataType : 'json',
                       success : function (data){
                           $.each(data, function(){
                                    ...
                                    foreach ($rgetservices as $result)
                                    {
                                         ...
                                         if(preg_match("/RTG/i", $menugroup))
                                         {
                                             if(preg_match("/RTG2/i", $menugroup)){
                                                ...
                                                if(preg_match("/RTG - Abbott/i", $vname))
                                                {
                                             ...
                                             else
                                             {
                                                ...
                                                else if(preg_match("/RTG/i", $vname)){
                                                    echo "<option value=\"".$vserviceID."\">".$vname."</option>";
                                                }
                                             }
                                         ...
                                         {
                                            //select only MG Servers from the DB 
                                            if(preg_match("/PT/i", $vname))
                                            {
                                                echo "<option value=\"".$vserviceID."\">".$vname."</option>";
                                            }
                                         }
                                         if(preg_match("/v15/i", $menugroup))
                                         {
                                            //select only MG Servers from the DB 
                                            if(preg_match("/v15/i", $vname))
                                            {
                                                echo "<option value=\"".$vserviceID."\">".$vname."</option>";
                                            }
                                         }
