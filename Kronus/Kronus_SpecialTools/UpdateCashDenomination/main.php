...
if($connected)
{
    ...
    foreach($allsites as $value){
        ...
        if($sitecounts['Count'] > 0){
            ...
            $sitedenom = $vcashier->updatesitedenom($siteid,$siteid);
    ...
    if($sitecount > 0 && $sitefailed == 0){
        ...
        $message = "Failed to update Site Denomination, $sitefailed Sites Failed to Update Sites Failed to Update, SiteID ".$sites;
    }
