...
define ( 'RTGCerts_DIR', 'C://xampp/htdocs/kronus.admin.abbott.version/public/views/sys/config/RTGClientCerts/'); //staging
...
$cashierlogpath = "C://xampp/htdocs/Kronus_UB/cashier.abbott.version/app/frontend/logs/";
$gpasscode_len = 3;
...
$cardinfo = 'http://172.16.102.174/membership.rewards/API/cardinquiry.php'; //for getting membership card information
...
$gcashierupdate = "http://172.16.102.174/Kronus_UB/cashier2.pagcoregames.com/index.php?r=updatepassword&"; //staging
$gadminupdate = "http://172.16.102.174/Kronus_UB/admin2_ub.pagcoregames.com/public/views/UpdatePassword.php?"; //staging
$launchPadLogPath = '/var/www/Launchpad_UB/protected/runtime/'; //path for launchpad logs
$adminlogpath = "C://xampp/htdocs/kronus.admin.abbott.version/public/views/sys/log/";
...
$groupemail_daily = array('elperez@philweb.com.ph'); //list of emails for daily buy in report
$groupemaildb = array('elperez@philweb.com.ph');
