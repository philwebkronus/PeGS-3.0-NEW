...
//                                {
                                    ...
                                    {
                                        echo "<li>";
                                        echo "<a href='#' onclick=\"loadsubpage('blank.php','".$group."','".$submenu->getAttribute('pagename')."');\">$group</a>";
                                    ...
                                    elseif (($tmpgroup != $group) && (!empty($group)))
                                    {
                                        ...
                                        else
                                        {
                                            ...
                                            <li>
                                            <a href='#' onclick=\"loadsubpage('blank.php','".$group."','".$submenu->getAttribute('pagename')."');\" >$group</a>
                                                <ul class='$selected'>";
                                        }
...
//                                }
                                ...
                                echo "<li><a style=\"background-color: #CCCCCC; color: #000000\" href='#' onclick=\"loadsubpage('".$path."','".$group."','".$submenu->getAttribute('pagename')."');\" >".$name."</a></li>"; 
