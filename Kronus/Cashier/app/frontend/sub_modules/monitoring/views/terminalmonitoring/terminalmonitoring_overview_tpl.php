...
<div id="temrinalmonitoring-pager">
    Terminals: <?php echo TerminalMonitoringPager::display(($total_terminal / 2), Mirage::app()->param['terminal_per_page'] * 2,'monitoring/overview'); ?>
</div>
...
<script type="text/javascript" src="jscripts/terminal-monitoring-pager-plain.js"></script> 
...
<script type="text/javascript" src="jscripts/refresh-every-minute.js"></script>
<?php Mirage::loadLibraries(array('ButtonClickScripts','HotkeyScripts','LoyaltyScripts','RefreshScripts')); ?>
