...
<!--        <script type="text/javascript" src="https://getfirebug.com/firebug-lite.js"></script>-->
    ...
    <body>
                ...
                <div id="top-header">
                    ...
                    <?php
                        echo Menu::display(array(
                            ...
                            'View Transaction'=>array('link'=>$this->createUrl('viewtrans/overview'),'act'=>'overview','con'=>'ViewTransaction','attr'=>'desc="View Transactions"'),
        ...
        <?php endif; ?>
        <div style="text-align: center">PAGCOR e-Games Station Manager. Copyright &copy; 2011. PhilWeb Corporation. All rights reserved.</div>
