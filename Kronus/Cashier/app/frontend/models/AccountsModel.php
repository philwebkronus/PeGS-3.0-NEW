...
//    }    
    ...
    public function checkusernameandemail($zusername,$zemail){
        $sql = "Select COUNT(*) count from accounts a INNER JOIN accountdetails b ON a.AID = b.AID WHERE a.UserName = :username and b.Email = :email";
   ...
   public function checkemail($zemail){
       $sql = 'SELECT COUNT(*) count, UserName FROM accounts a INNER JOIN accountdetails b ON a.AID = b.AID where Email = :email';
