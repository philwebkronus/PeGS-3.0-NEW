...
class StackerSummaryModel extends MI_Model {
    ...
    public function getStackerSummaryTicketCodes($stackersummaryids) {
        $sql = "SELECT Withdrawal, TicketCode FROM stackersummary WHERE StackerSummaryID IN ($stackersummaryids) AND TicketCode IS NOT NULL";
        $this->exec2($sql);
