...
return array(
    ...
    'domain'=>'http://'.$_SERVER["SERVER_NAME"].'/Kronus.UB.New/cashier.ewallet3/index.php', // localhost
    // LOGS
    'logs'=>array(
...
//        'card_inquiry'=>'http://172.16.102.174/membership.rewards/API/cardinquiry.php',
//        'transfer_points' => 'http://172.16.102.174/membership.rewards/API/transferpoints.php',
//        'member_activation' => 'http://172.16.102.174/membership.rewards/memberactivation.php',
//        'process_points' => 'http://172.16.102.174/membership.rewards/API/addpoints.php',
//        'temp_activation' => 'http://172.16.102.174/membership.rewards/tempmemberactivation.php',
//        'register_account' => 'http://172.16.102.174/membership.rewards/registration.php',
//        'loyalty_service'=>7,
        
        //test SP
        'card_inquiry'=>'http://172.16.102.174/membership.rewards.v02/API/cardinquiry.php',
        'transfer_points' => 'http://172.16.102.174/membership.rewards.v02/API/transferpoints.php',
        'member_activation' => 'http://172.16.102.174/membership.rewards.v02/memberactivation.php',
        'process_points' => 'http://172.16.102.174/membership.rewards.v02/API/addpoints.php',
        'temp_activation' => 'http://172.16.102.174/membership.rewards.v02/tempmemberactivation.php',
        'register_account' => 'http://172.16.102.174/membership.rewards.v02/registration.php',
        'loyalty_service'=>7,
        ...
        'logout_page'=>'http://'.$_SERVER["SERVER_NAME"].'/Kronus.UB.New//cashier.ewallet3/index.php?r=logout', // localhost
        'cut_off'=>'06:00:00',
        ...
        'generate_voucher'=>'http://192.168.41.60/vouchermanagementsystem/VMS/index.php/voucherAPI/generate/',
        'verify_voucher'=>'http://192.168.41.60/vouchermanagementsystem/VMS/index.php/wsvoucher/verify/',
        'use_voucher'=>'http://192.168.41.60/vouchermanagementsystem/VMS/index.php/wsvoucher/use/',
        'cancel_voucher'=>'http://192.168.41.60/vouchermanagementsystem/VMS/index.php/voucherAPI/cancel/',
        'update_voucher'=>'http://192.168.41.60/vouchermanagementsystem/VMS/index.php/voucherAPI/update/',
        'voucher_source'=>3,
        ...
        'Asynchronous_URI'=>'http://'.$_SERVER["SERVER_NAME"].'/Kronus_ForceT/cashier.ewallet3/index.php',
...
//PCWS
        'pcwsforcelogout'=>'172.16.102.174/PCWS.v02/index.php/pcws/forcelogout',
        'pcwsunlock'=>'172.16.102.174/PCWS.v02/index.php/pcws/unlock',
        'referrer'=>'http://localhost/Kronus.UB.New/cashier.ewallet3/index.php?r=login',
    ),
);
