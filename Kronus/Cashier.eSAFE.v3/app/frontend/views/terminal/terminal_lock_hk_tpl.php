...
<div id="tm-reload-form">
    <div>
        <form id="frmredeem">
            <table>
                <tr>
                    <th class="left"><?php echo MI_HTML::label($UnlockTerminalFormModel, 'terminal_id', 'TERMINAL:'); ?></th>
                    <td><?php echo MI_HTML::dropDownArray($UnlockTerminalFormModel, 'terminal_id', $terminals, 'id', 'code', array(''=>'Select Terminal'),null,array('id'=>'close_terminal_id')) ?></td>
                </tr>
                <tr>
                ...
                <tr>
                    <th><input id="btnRedeemClose2" type="submit" value="Submit" /></th>
