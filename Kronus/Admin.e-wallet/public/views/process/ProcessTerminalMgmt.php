                   ...
                   if($vgenpwdid > 0)
                   {
                      ...
                      if($usermode == 0){
                          $vapiResult = $_CasinoGamingPlayerAPI->createTerminalAccount($vprovidername, 
                                              $serverId, $url, $login, $password, $aid, $currency, $email, $fname, 
                       ...
                       else
                       {
                           ...
                           if($vapiResult['ErrorCode'] == 5 || $vapiResult['ErrorCode'] == 1 || $vapiResult['ErrorCode'] == 3 ||  $vapiResult['ErrorID'] == 5)
                           {
                                       ...
                                       $vrtgoldpwd = $vapiResult['AccountInfo']['password'];
                                        ...
                                        if($usermode == 0){
                                            $vapiResult = $_CasinoGamingPlayerAPI->changeTerminalPassword($vprovidername, 
                                                        $serverId, $url, $casinoID, $login, $vrtgoldpwd, $password, 
                               ...
                               else if(strstr($vprovidername, "MG") == true)
                               {
                                   ...
                                   $vapiResult = $_CasinoGamingPlayerAPI->validateCasinoAccount($login, $serverId, 
                                                    $url, $capiusername, $capipassword, $capiplayername, $capiserverID,$password);
                                   ...
                                   if(isset($vapiResult['IsSucceed']) && $vapiResult['IsSucceed'] == true)
                                   {
                                        ...
                                        if($vaccountExist)
                                        {
                                            ...
                                            $vapiResult = $_CasinoGamingPlayerAPI->resetCasinoPassword($login, $password, $serverId, $url, 
                                                                                    $capiusername, $capipassword, $capiplayername, $capiserverID);
                                        }
                                   }
                               } 
                               ...
                               //if Provider is PT, then
                               else 
                                {
                                   ...
                                   $voldpw = '';
                                    ...
                                    $vapiResult = $_CasinoGamingPlayerAPI->changeTerminalPassword($vprovidername, $serverId, 
                                                                            $url, $casinoID, $login, $voldpw, $password, $capiusername, 
