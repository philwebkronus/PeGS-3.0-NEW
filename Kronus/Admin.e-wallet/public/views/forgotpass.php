    ...
    <body onload ="preventBackandForward();document.getElementById('txtemail').focus();">
        <form method="post" action="process/ProcessLogin.php">
            ...
            <fieldset style="width:350px;height:160px;">
                <p class ="legend">Forgot Password</p>
                <br />
                <table align="center">
                    <tr>
                        <td>Email Address</td>
                    ...
                    <tr>
                        <td>
                           <input type="text" id="txtemail" name="txtemailforpass" maxlength="100" ondragstart="return false" onselectstart="return false" onpaste="return false" onkeypress="return emailkeypress(event);"/> 
                        </td>
                    </tr>
                </table>
                <p class="submit">
