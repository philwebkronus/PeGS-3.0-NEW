...
define ( 'RTGCerts_DIR', 'http://172.16.102.174/kronus.admin.ewallet/public/views/sys/config/RTGClientCerts/'); //staging
...
$Pcws = array(
    ...
    'forcelogout' => '172.16.102.174/PCWS/index.php/pcws/forcelogout', 
