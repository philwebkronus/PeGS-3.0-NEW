...
<div id="workarea">
    ...
    <form method="post" action="process/ProcessTopUp.php">
        ...
        <div id="submitarea">
            <input type="button" id="btnconfirm" value="Submit" />
        </div>
        <div id="light" class="white_page">
            ...
            <p align="center" style="font-weight: bold;"> Provincial PeGs Confirmation </p>
            <input type="hidden" name="page" value="InsertPegsConfirmation" />
            ...
            <table align="center">
                ...
                <tr>
                    <td>Who:</td>
                    <td>
                        <input type="text" name="txtwho" id="txtwho" onkeypress="return letter(event);" />
                    </td>
                </tr>
                <tr>
                    <td>Amount Confirmed:</td>
                    <td>
                        <input class="auto" type="text" name="txtamount" id="txtamount" onkeypress="return numberonly(event);" />
                    </td>
                </tr>
                <tr>
                    <td>&nbsp;</td>
                ...
                <tr align="right">
                    <br />
                    <td>
                        <input type="submit" value="Submit" onclick="return chkconformation();"/>
                    </td>
                    <td>
