...
<div id="workarea">
    <div id="pagetitle">Gross Hold Monitoring 2 (For Testing Purposes only)</div>
    <br />
   ...
   jQuery(document).ready(function(){
    ...
    //    return accounting.formatMoney(val, pre, 2, ".", ",");
      ...
      jQuery('#btnsearch').click(function(){
        ...
        $.ajax({
                url: 'process/ProcessTopUpPaginate.php?action=getdataz3&sellocation='+''+'&comp1='+''+'&num1='+''+'&comp2='+''+'&num2='+'',
                type: 'GET',
                data : {
