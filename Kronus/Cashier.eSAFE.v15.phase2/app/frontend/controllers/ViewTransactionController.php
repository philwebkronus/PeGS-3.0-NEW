...
class ViewTransactionController extends FrontendController {
    ...
    public function viewEwalletTransactionPerVirtualCashierAction()
    {
        ...
        if($jsonMode){
            ...
            $this->renderPartial('viewtransaction_ewallet_per_virtualcashier', array('transactionHistory'=>$transactionHistory));
        }
    }
    ...
    public function viewEwalletTransactionPerSiteAction()
    {
        ...
        if($jsonMode){
            ...
            $this->renderPartial('viewtransaction_ewallet_per_site', array('transactionHistory'=>$transactionHistory));
        }
    }
