...
class CommonUBReload {
    ...
    public function reload($bcf,$amount, $paymentType,$terminal_id,$site_id,$service_id,$acctid,
            ...
            $casinoUsername = '',$casinoPassword = '', $casinoServiceID = '', $traceNumber='', $referenceNumber='', $locatorname = '') {
        ...
        Mirage::loadModels(array('TransactionSummaryModel','TerminalsModel','EgmSessionsModel','StackerSummaryModel',
                                 ...
                                 'PendingUserTransactionCountModel', 'BankTransactionLogsModel'));
        ...
        list($terminal_balance,$service_name,$terminalSessionsModel,
                $transReqLogsModel,$redeemable_amount,$casinoApiHandler,$mgaccount) = $casinoApi->getBalanceUB($terminal_id, $site_id, 'R', 
        ...
        /************************* RELOAD *************************************/
        $resultdeposit = $casinoApiHandler->Deposit($casinoUsername, $amount, 
        ...
        if ($apiresult == 'true' || $apiresult == 'TRANSACTIONSTATUS_APPROVED' || $apiresult == 'approved'){
            ...
            $isupdated = $commonTransactionsModel->reloadTransaction($amount, $trans_summary_id, 
                            $udate, $site_id, $terminal_id, 'R', $paymentType,$service_id, 
                            $acctid, $transstatus, $total_reload_balance, 
