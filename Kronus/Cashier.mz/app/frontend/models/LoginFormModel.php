...
/* Filtering of Non-e-Bingo Site Cashiers
 * 
          $siteClassification = $accountsModel->checkCashierSiteClassification($this->username);
            if($siteClassification == 1 || $siteClassification == 2){
                    $this->setAttributeErrorMessage('message', "You are not allowed to login to this cashier instance.");
                    $this->close();
                    return false;
            }  
 */       
