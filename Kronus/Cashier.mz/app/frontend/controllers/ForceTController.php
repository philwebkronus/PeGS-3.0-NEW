...
class ForceTController extends FrontendController {
    ...
    public function overviewAction(){
        ...
        $this->render('forcet_overview', array('FTModel'=>$FTModel, 'transaction_type'=>$transaction_type,'siteAmountInfo' => $siteAmountInfo));
    }
    ...
    public function loadAction(){
        ...
        $siteAmountInfo = $sitesModel->getSiteAmountInfo($this->site_id);
        $this->renderPartial('forcet_load', array('FTModel'=>$FTModel, 'sel_terminals'=>$sel_terminals, 'banks'=>$banks,'siteAmountInfo' => $siteAmountInfo));
    }
    ...
    public function withdrawAction(){
        ...
        $terminals = $terminalsModel->getAllActiveForceTTerminals($this->site_id, $this->len);
        $siteAmountInfo = $sitesModel->getSiteAmountInfo($this->site_id);
        $this->renderPartial('forcet_withdraw', array('FTModel'=>$FTModel, 'terminals'=>$terminals,'siteAmountInfo' => $siteAmountInfo));
    }
    ...
    public function geteSAFEtransSessionDetailsAction() {
        if(!$this->isAjaxRequest() || !$this->isPostRequest())
            ...
            $isbyterminal = isset($_POST['isbyterminal']) ? $_POST['isbyterminal'] : '';
            if(!empty($isbyterminal)){
