...
//        }   
    ...
    public static function apirequestlog($message, $type, $newLine = false) {
        $logname = "Pcws_".self::uDateTime('Y_m_d').'.log';
        self::$pcws_logname = $logname;
        ...
        $log_path = $logs['log_path'] . DIRECTORY_SEPARATOR;  
            ...
            if(file_put_contents($log_path .  self::$pcws_logname, $message, FILE_APPEND) === false)
                    throw new Exception($log_path .self::$pcws_logname . ' is not writable');   
    }
