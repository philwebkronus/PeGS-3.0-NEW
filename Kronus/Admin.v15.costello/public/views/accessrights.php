    ...
    <form method="post" action="process/ProcessMenuMaintenance.php">
        ...
        <table>
            ...
            <tr>
                <td>Order</td>
                <td>
                    <input type="text" id="txtorderid" name="txtorderid" readonly="readonly" size="10" maxlength="10" onkeypress="return numberonly(event);" />
                </td>
            </tr>
            <tr>
                <td>Default URL</td>
                <td>
                    <input type="text" name="txturl" id="txturl" readonly="readonly" value="main.php" onkeypress="return urlvalidation(event);" />
                </td>
            </tr>
            <tr>
                <td>Default URL2</td>
