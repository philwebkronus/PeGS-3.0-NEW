...
class Login extends DBHandler
{
   ...
   public function checkusernameandemail($zusername,$zemail){
       $this->prepare("SELECT COUNT(*) count, AccountTypeID acctype FROM accounts a INNER JOIN accountdetails b ON a.AID = b.AID WHERE a.UserName = :username and b.Email = :email");
