                ...
                isset($_POST['usermode']))
                {
                    ...
                    else
                    {
                        ...
                        $serviceid = $ocasino->updateService($upServiceName, $upServiceAlias,
                                $upServiceCode,$upServiceDesc ,$upServiceGrp, $mode, $ServiceID);
                        //no records change
                        if($serviceid > 0)
                        {
                            ...
                            // ADDED CCT 07/03/2018 BEGIN
                            $msg = "Casino Services Update : Service Casino updated";
                            // ADDED CCT 07/03/2018 END
                        }
