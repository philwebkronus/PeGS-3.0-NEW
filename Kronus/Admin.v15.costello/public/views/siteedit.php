...
if (isset($_SESSION['acctype']))
{
    ...
    else
    {
        ...
        else
        {
            ...
            $rsiteclass = $rdemogs['Site Classification'];
            ...
            foreach ($rsitedet as $resultviews)
            {
                ...
                $vtmtab = $resultviews['TMTab'];
                $vsrrtab = $resultviews['SRRTab'];
                $vesafetab = $resultviews['ESafeTab'];
                    ...
                    <tr>
                        ...
                        <td>                                
                            ...
                            foreach ($vsiteclass as $result)
                            {
                                ...
                                if ($vsiteClassification == $vSiteId)
                                {
                                    echo "<option value=\"" . $vSiteId . "\" selected=\"selected\">" . $vname . "</option>";
                                }
                                else
                                {
                    ...
                    <table >
                        ...
                        <tr>
                            ...
                            if ($vtmtab == 0)
                            {
                                ?>
                                <td>
                            <center><input type="radio" id="tmtab" name="tmtab" value=" 1" /></center>
                            </td>
                            <td>
                            <center><input type="radio" id="tmtab" name="tmtab" value="0" checked /></center>
                            </td>
                            <?php
                        }
                        else
                        ...
                        <tr>
                            ...
                            if ($vsrrtab == 0)
                            {
                                ?>
                                <td>
                            <center><input type="radio" id="srrtab" name="srrtab" value="1" /></center>
                            </td>
                            <td>
                            <center><input type="radio" id="srrtab" name="srrtab" value="0" checked /></center>
                            </td>
                            <?php
                        }
                        else
                        ...
                        <tr>
                            ...
                            if ($vesafetab == 0)
                            {
                                ?>
                                <td>
                            <center><input type="radio" id="esafetab" name="esafetab" value="1" /></center>
                            </td>
                            <td >
                            <center><input type="radio" id="esafetab" name="esafetab" value="0" checked s/></center>
                            </td>
                            <?php
                        }
                        else
