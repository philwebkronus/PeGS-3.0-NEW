    ...
    if(isset($_SESSION['acctype']))
    {
        ...
        else
        {
            ...
            else
            {
                ...
                $rusermodename = $resultviews['UserModeName'];
                $rstatus = $resultviews['Status'];
               }
                $_SESSION['serviceid'] = $rserviceID;
               
                $arrolddetails = array($rusermodename, $rserviceID, $rservicgename, $rservname, $rsalias, $rscode, $rservcdesc, $rusermode, $rstatus);
            ...
            <table>
                ...
                <tr>
                    <td>Mode</td>                            
                            ...
                            $vusermode = $_SESSION['UserMode'];
                            echo "<select id='usermode' name='usermode' >";
                                foreach ($vusermode as $result)
                            {
                                 $usermode = $result['UserMode'];
                                 $usermodename = $result['UserModeName'];
                                if ($rusermode == $usermode)
                                {
                                    echo "<option value=\"" . $usermode . "\" selected=\"selected\">" . $usermodename . "</option>";
                                }
                                else
                                {
                                    echo "<option value=\"" . $usermode . "\">" . $usermodename . "</option>";
                                }
                            }
