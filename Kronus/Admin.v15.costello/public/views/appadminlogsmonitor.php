...
<script type="text/javascript">
    jQuery(document).ready(function(){
       ...
       jQuery.ajax({
           url : url,
           type : 'post',
           data : {page2 : function(){return 'GetAdminLogFile';}},
           dataType : 'json',
        ...
        jQuery(".afiles").live('click', function(){
           getlogcontents('ShowAdminLogContent', jQuery(this).text());
        });
        ...
        jQuery("#btnsearch").click(function(){
           ...
           if (result == true)
           { 
               getlogcontents('ShowAdminLogContent', date); 
           }
        });
