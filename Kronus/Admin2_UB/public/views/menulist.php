                 ...
                 <?php                       
                    ...
                    if($menu->length)
                    {
                        ...
                        foreach ($menu as $menu)
                        {
                            ...
                            {
                                echo "<li><a href=\"#\" class='menulist active' onclick=\"loadpage('".$menu->getAttribute("path") . "','". $menid ."');\" >".$menu->getAttribute("name")."</a></li>";   
                            }
                            else
                            {
                                echo "<li><a href=\"#\" class='menulist' onclick=\"loadpage('".$menu->getAttribute("path") . "','". $menid ."');\" >".$menu->getAttribute("name")."</a></li>";   
                            }
                        }
                        echo "</ul>";                                              
                    }
