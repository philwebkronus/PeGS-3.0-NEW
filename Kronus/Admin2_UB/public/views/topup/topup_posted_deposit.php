...
<script type="text/javascript">
    jQuery(document).ready(function(){
        ...
        jQuery('#btnsearch').click(function(){
          ...
          jQuery("#pdgrid").jqGrid('setGridParam',{url:"process/ProcessTopUpPaginate.php?action=getdataposteddeposit&startdate="+startdate+
        ...
        jQuery("#pdgrid").jqGrid({
            ...
            datatype: "json",
            colNames:['Site / PEGS Name','POS Account','Bank','Branch','Bank Transaction ID','Deposit Date','Cheque Number','Amount','Remittance Type','Site Transaction Date','Date Created', 'Verified By'],
            rowNum:10,
            rowList:[10,20,30],
            height: 280,
            width: 1250,
            ...
            colModel:[
                ...
                {name:'DepositDate',index:'DateCreated',align:'left'},
                ...
                {name:'SiteTransactionDate',index:'DateUpdated',align:'left'},
                {name:'DateCreated',index:'DateCreated',align:'left'},
                {name:'VerfiedBy',index:'PostedBy',align:'left'}
            ],
            resizable:true
        });
    });
