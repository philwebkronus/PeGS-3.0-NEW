 ...
 **/
        ...
        jQuery(document).ready(function(){
            ...
            function sendIslandID(str){
                var siteURL = window.location.protocol + "//" + window.location.host + "/" + "process/ProcessSiteManagement.php";
            ...
            function sendCityID(str){
             ...
             function sendSiteID(str){
                var suppURL = window.location.protocol + "//" + window.location.host + "/" + "process/ProcessAppSupport.php";
            ...
            function sendSiteID1(str){
                var suppURL = window.location.protocol + "//" + window.location.host + "/" + "process/ProcessTerminalMgmt.php";
           ...
           //this is for casino service view 
            function sendServiceGroupID(str){
                var suppURL = window.location.protocol + "//" + window.location.host + "/" + "process/ProcessCasinoMgmt.php";
            ...
            function sendAccID(str){
                var suppURL = window.location.protocol + "//" + window.location.host + "/" + "process/ProcessAccManagement.php";
            ...
            function sendRemitID(str){
                var suppURL = window.location.protocol + "//" + window.location.host + "/" + "process/ProcessTopUp.php";
       ...
       //this is for siteremmitance for verified remmittances
            ...
            function sendSiteID2(str){
                var suppURL = window.location.protocol + "//" + window.location.host + "/" + "process/ProcessCSManagement.php";
            ...
            function sendSiteID_cs(str){
                var suppURL = window.location.protocol + "//" + window.location.host + "/" + "process/ProcessAppSupport_cs.php";
                $.post(suppURL,{sendSiteID: str},
                function(data){
                    var terminal = $("#cmbterm");
                    $.each(data, function() {
