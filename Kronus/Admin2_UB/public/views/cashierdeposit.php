  ...
  <form method="post" action="process/ProcessTopUp.php">
      ...
      <table>
        ...
        <tr>
           <td>Amount</td>
           <td>
               <input class="auto" id="txtAmount" name="txtAmount" maxlength='10' onkeypress="javascript: return numberonly(event);"/>
           </td>
        </tr>
        <tr>
        ...
        <tr>
           ...
           <td>
              ...
              <img name="cal" src="images/cal.gif" width="16" height="16" border="0" alt="Pick a date" onClick="displayDatePicker('txtBankTransDate', false, 'ymd', '-');"/>
           </td>
        </tr>
        <tr>
            <td>Site Transaction Date</td>
            <td>
        ...
        <tr>
           <td>Particulars</td>
           <td><input id="txtParticulars" name="txtParticulars" maxlength="50" onkeypress="return numberandletter1(event);"/></td>
        </tr>
     </table>
     <div id="submitarea">
