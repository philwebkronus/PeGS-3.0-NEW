        ...
        if(isset ($_POST['page']))
        {
            ...
            switch($vpage)
            {
              ...
              case "GetCasino":
                      ...
                      foreach ($casinos[0] as $value) {
                            ...
                            foreach ($servicename as $service2) {
                                  ...
                                  else
                                  {
                                    ...
                                    switch (true){
                                    case strstr($serviceName, "RTG"): //if provider is MG, then
                                        $url = $_ServiceAPI[$rserviceid-1];
                                        $capiusername = $_CAPIUsername;
                                        $capipassword = $_CAPIPassword;
                                        $capiplayername = $_CAPIPlayerName;
                                        $capiserverID = '';
                                        $balance = $CasinoGamingCAPI->getBalance($serviceName, $rserviceid, $url, $rserviceuname, $capiusername, $capipassword, $capiplayername, $capiserverID); 
                                        break;
                  ...
                  {
                      echo "User Based Redemption: Invalid Card Number";
                  }
                unset($casino);
                unset($casino2);            
                $ocs->close();
