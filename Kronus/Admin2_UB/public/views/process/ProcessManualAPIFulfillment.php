       ...
       switch($vpage)
       {
          ...
          //verify casino and transaction search information
            ...
            case (strstr($txtcasino, "RTG")):
                    ...
                    $capiserverID = '';
                    $transSearchInfo = $CasinoGamingCAPI->TransSearchInfo($txtcasino, $serviceID, $url, $login, $capiusername, $capipassword, $capiplayername, $capiserverID, $tracking1, $tracking2, $tracking3, $tracking4);
          ...
          //validate data for casino fulfillment
             ...
             //if transaction status is Approved
                      ...
                      else
                      {
                        ...
                        {   
                            ...
                            if($insrttermsess == true)
                            {
                                ...
                                $trans = $maf->startTransaction($cmbsite, $cmbterm, $amount, $aid, $txttransrefid, 'D', $serviceid, 
                                    $transstatus, $cardnumber, $mid);
                        ...
                        if($txttranstype == 'Reload')    
                        {
                            ...
                            switch (true)
                            {
                                case (strstr($txtcasino, "RTG")):
                                    ...
                                    $capiplayername = $_CAPIPlayerName;
                                    $capiserverID = '';
                                    $balance = $CasinoGamingCAPI->getBalance($txtcasino, $serviceid, $url, $txtusername, 
                            ...
                            if($insrttermsess == true)
                            {
                                ...
                                $trans = $maf->reloadTransaction($amount, $trans_summary_id, $txttransrefid, $cmbsite,
                                $cmbterm, 'R', $serviceid, $aid, 
                                $transstatus, $total_reload_balance, $total_terminal_balance, 
                                $cardnumber, $mid);
                            }      
                            else
                            {
                        ...
                        {   
                            ...
                            if($insrttermsess == true)
                            {
                                ...
                                $trans = $maf->redeemTransaction($amount, $trans_summary_id, $txttransrefid, $cmbsite,
                                      $cmbterm, 'W', $serviceid, $aid,
                                      $transstatus, $cardnumber, $mid);   
                            }
                            else
                            {
                      ...
                      {   
                            ...
                            switch (true)
                            {
                                case (strstr($txtcasino, "RTG")):
                                        ...
                                        $capiplayername = $_CAPIPlayerName;
                                        $capiserverID = '';
                                        $deposit = $CasinoGamingCAPI->Deposit($txtcasino, $serviceid, $url, $txtusername, 
                                                $capiusername, $capipassword, $capiplayername, $capiserverID, $amount, 
                                ...
                                if(isset($deposit['IsSucceed']) && $deposit['IsSucceed'] == true) 
                                {
                                    ...
                                    if($uptrans > 0){
                                        ...
                                        switch (true)
                                           ...
                                           $inserttranslogs = $maf->insertTransactionreqlogslp($transreferid, $amount, $transtype, $cmbterm, $status, $cmbsite, 
                                                $transrefid, $apiresult, $serviceid, $servicetransferhisid, $txtcardnumber, $mid, 
                                                $usermode, $transsummaryid, $paymenttype);
                                ...
                                if(isset($deposit['IsSucceed']) && $deposit['IsSucceed'] == true) 
                                {
                                        ...
                                        if($uptrans > 0){
                                            ...
                                            switch (true)
                                                ...
                                                //insert in transactionrequestlogslp
                                               $inserttranslogs = $maf->insertTransactionreqlogslp($transreferid, $amount, $transtype, $cmbterm, $status, $cmbsite, 
                                                    $transrefid, $apiresult2, $serviceid, $servicetransferhisid, $txtcardnumber, $mid, 
                                                    $usermode, $transsummaryid, $paymenttype);  
                                            //check if insert in transactionrequestlogslp is successful   
                                            if($inserttranslogs > 0)
                                            {
              ...
              unset($uptrans, $txttranstype,$balance, $terminal_balance, 
                      $total_terminal_balance, $amount, $trans_summary_id, $bcf, $deposit, $msg);
