    ...
    if(isset($_POST['page']))
    {
        ...
        switch ($vpage)
        {
            case 'BatchTerminalCreation':
                    ...
                    if($vgenpwdid > 0)
                    {
                        ...
                        for($ctrterminal = 1; $ctrterminal <= $vterminals; $ctrterminal++)
                        {
                            ...
                            if(isset($vprovider) && $vprovider == "MG")
                            {
                                ...
                                $vplayerResult = $_CasinoGamingPlayerAPI->createTerminalAccount($vprovider, $vserviceID,
                                        $mgurl, $login, $password, $aid, $currency, $email, $fname, $lname, $dayphone,
                                        $evephone, $addr1, $addr2, $city, $country, $state, $zip, $userID, $birthdate,
                                        $fax, $occupation, $sex, $alias, $casinoID, $ip, $mac, $downloadID, $clientID,
                                ...
                                if(isset($vplayerResult['IsSucceed']) && $vplayerResult['IsSucceed'] == true)
                                {
                                    ...
                                    $isrecorded = $obatch->createbatchterminals($isapisuccess, $vterminalName, $vterminalCode,
                                            $vsiteID, 1, $vCreatedByAID, $visVIP, $vserviceID, 1, $vgenpassword, $vgenhashed);
                                    ...
                                    $vplayerResult = $_CasinoGamingPlayerAPI->createTerminalAccount($vprovider,
                                            $vserviceID, $mgurl, $login, $password, $aid, $currency, $email, $fname,
                                            $lname, $dayphone, $evephone, $addr1, $addr2, $city, $country, $state,
                                            $zip, $userID, $birthdate, $fax, $occupation, $sex, $alias, $casinoID, $ip, $mac,
                                            $downloadID, $clientID, $putInAffPID, $calledFromCasino, $hashedPassword, $agentID,
                                            $currentPosition, $thirdPartyPID, $capiusername, $capipassword, $capiplayername, $capiserverID);
                                    ...
                                    if (isset($vplayerResult['IsSucceed']) && $vplayerResult['IsSucceed'] == true)
                                    {
                                        ...
                                        if($vplayerResult['ErrorCode'] == 1)
                                        {
                                           ...
                                           $vplayerResult = $_CasinoGamingPlayerAPI->validateCasinoAccount($login, $vserviceID,
                                                                $mgurl, $capiusername, $capipassword, $capiplayername, $capiserverID,$password);
                                           ...
                                           if(isset($vplayerResult['IsSucceed']) && $vplayerResult['IsSucceed'] == true)
                                           {
                                                ...
                                                if($vaccountExist)
                                                {
                                                    ...
                                                    $vplayerResult = $_CasinoGamingPlayerAPI->resetCasinoPassword($login, $password, $vserviceID, $mgurl,
                                    ...
                                    $logterminals = $obatch->logbatchterminals($vsiteID, $vipterminal, 
                                                        $isapisuccess,$vCreatedByAID, $vserviceID);
                                } else {
                                ...
                                $logterminals = $obatch->logbatchterminals($vsiteID, $regterminal, 
                                                    $isapisuccess,$vCreatedByAID, $vserviceID);
                            }
                            ...
                            if (isset($rtgvprovider) && $rtgvprovider == "RTG")
                            {
                                ...
                                $vplayerResult = $_CasinoGamingPlayerAPI->createTerminalAccount($rtgvprovider, $rtgvserviceID,
                                    $rtgurl, $login, $password, $aid, $currency, $email, $fname, $lname, $dayphone,
                                    $evephone, $addr1, $addr2, $city, $country, $state, $zip, $userID, $birthdate,
                                    $fax, $occupation, $sex, $alias, $casinoID, $ip, $mac, $downloadID, $clientID,
                                    $putInAffPID, $calledFromCasino, $hashedPassword, $agentID, $currentPosition,
                                    $thirdPartyPID, $capiusername, $capipassword, $capiplayername, $capiserverID);
                                ...
                                if (isset($vplayerResult['IsSucceed']) && $vplayerResult['IsSucceed'] == true)
                                {
                                    ...
                                    $isrecorded = $obatch->createbatchterminals($isapisuccess, $vterminalName, $vterminalCode,
                                            $vsiteID, 1, $vCreatedByAID, $visVIP, $rtgvserviceID, 1, $vgenpassword, $vgenhashed);
                                    ...
                                    else
                                    {
                                        ...
                                        if ($vplayerResult['ErrorCode'] == 5 )
                                        {
                                                    ...
                                                    $vplayerResult['AccountInfo']['password'] <> null)
                                            {
                                               ...
                                               $vplayerResult = $_CasinoGamingPlayerAPI->changeTerminalPassword($rtgvprovider,
                                                                $rtgvserviceID, $rtgurl, $casinoID, $login, $vrtgoldpwd, $password,
                                                                $capiusername, $capipassword, $capiplayername, $capiserverID);
                                    ...
                                    $logterminals = $obatch->logbatchterminals($vsiteID, $vipterminal, $isapisuccess,
                                                    $vCreatedByAID, $rtgvserviceID);
                                } else {
                                ...
                                //LOG creation of RTG Accounts
                                $logterminals = $obatch->logbatchterminals($vsiteID, $regterminal, $isapisuccess,
                                                $vCreatedByAID, $rtgvserviceID);
                            }
                            ...
                            if(isset($ptvprovider) && $ptvprovider == 'PT')
                            {
                                ...
                                $vplayerResult = $_CasinoGamingPlayerAPI->createTerminalAccount($ptvprovider, $ptvserviceID,
                                                    $pturl, $login, $password, $aid, $currency, $email, $fname, $lname, $dayphone,
                                                    $evephone, $addr1, $addr2, $city, $country, $state, $zip, $userID, $birthdate,
                                                    $fax, $occupation, $sex, $alias, $casinoID, $ip, $mac, $downloadID, $clientID,
                                                    $putInAffPID, $calledFromCasino, $hashedPassword, $agentID, $currentPosition,
                                                    $thirdPartyPID, $capiusername, $capipassword, $capiplayername, $capiserverID, 
                                ...
                                if(isset($vplayerResult['IsSucceed']) && $vplayerResult['IsSucceed'] == true)
                                {
                                    ...
                                    $isapisuccess = 1;
                                    $isrecorded = $obatch->createbatchterminals($isapisuccess, $vterminalName, $vterminalCode, 
                                                            $vsiteID, 1, $vCreatedByAID, $visVIP, $ptvserviceID, 1, $vgenpassword, $vgenhashed);
                                    array_push($arrterminalID, $isrecorded);
                                    ...
                                    $vplayerResult = $_CasinoGamingPlayerAPI->createTerminalAccount($ptvprovider,$ptvserviceID, $pturl, 
                                             $login, $password, $aid, $currency, $email, $fname,$lname, $dayphone, $evephone, $addr1, 
                                             $addr2, $city, $country, $state,$zip, $userID, $birthdate, $fax, $occupation, $sex, $alias, 
                                             $casinoID, $ip, $mac,$downloadID, $clientID, $putInAffPID, $calledFromCasino, $hashedPassword, 
                                             $agentID,$currentPosition, $thirdPartyPID, $capiusername, $capipassword, $capiplayername,
                                             $capiserverID,$ptVIP);
                                     ...
                                     if(isset($vplayerResult['IsSucceed']) && $vplayerResult['IsSucceed'] == true)
                                     {
                                        ...
                                        array_push($arrterminalID, $isrecorded);
                                         ...
                                         if($vplayerResult['ErrorCode'] == 3){
                                            ...
                                            //Call API change Password
                                            $vplayerResult = $_CasinoGamingPlayerAPI->changeTerminalPassword($ptvprovider, $ptvserviceID, $pturl, $casinoID, $login, 
                                                                           $voldpw, $password, $capiusername, $capipassword, $capiplayername, $capiserverID);

                                            //verify if API for change password(PT) is successfull
                                            if(isset($vplayerResult['IsSucceed']) && $vplayerResult['IsSucceed'] == true)
                                            {
                                                $isapisuccess = 1;
                                                $isrecorded = $obatch->createbatchterminals($isapisuccess, $vterminalCode, $vterminalCode, $vsiteID, 1, 
                                                                           $vCreatedByAID, $visVIP, $ptvserviceID, 1, $vgenpassword, $vgenhashed);
                                                array_push($arrterminalID, $isrecorded);
                                            } else {
                                                $isapisuccess = 0;
                ...
                unset($vsiteID, $vterminals, $vsitecode, $vlastterminal, $arrserverID,
                      $arrserverID1, $arrserverID2, $vCreatedByAID, $vStatus, $vterminalno, $arrterminalID,
                      $roldsite, $vgenpwdid, $ctrterminal, $vdateupdated, $vtransdetails,
                      $arraid, $vtitle, $raid, $dateformat, $rsites, $terminalID, $vmessage);
