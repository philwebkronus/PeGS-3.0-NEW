...
if(isset($_SESSION['acctype']))
{
    ...
    else
    {
        ...
        if(isset ($_SESSION['accdetails']))
        {
            ...
            $vaid = $vaccdetails['AID'];
            $vusername = $vaccdetails['Username'];
...
<div id="workarea">
    ...
    <form method="post" id="frmaccount" action="process/ProcessMenuMaintenance.php">
        ...
        <div id="light" class="white_confirm">
            ...
            <input type="hidden" id="txtaccid" name="txtaccid" value="<?php echo  $vaid; ?>" />
            <input type="hidden" name="optstatus" value="4" />
            <input type="hidden" name="txtuname" id="txtuname" value="<?php echo $vusername; ?>"/>
            <p>Are you sure you want to deactivate this account?</p>
            <p align="center"><?php echo $vusername; ?></p>
