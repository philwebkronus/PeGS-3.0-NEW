...
return array(
    ...
    'domain'=>'http://'.$_SERVER["SERVER_NAME"].'/Kronus_New/cashier.abbott.version/index.php', // localhost
    // LOGS
    'logs'=>array(
...
//	  'loyalty_service'=>7,
        ...
        'card_inquiry'=>'http://192.168.28.38/membership/membership.rewards/API/cardinquiry.php',
        'transfer_points' => 'http://192.168.28.38/membership/membership.rewards/API/transferpoints.php',
        'member_activation' => 'http://192.168.28.38/membership/membership.rewards/memberactivation.php',
        'process_points' => 'http://192.168.28.38/membership/membership.rewards/API/addpoints.php',
        'temp_activation' => 'http://192.168.28.38/membership/membership.rewards/tempmemberactivation.php',
        'register_account' => 'http://192.168.28.38/membership/membership.rewards/registration.php',
        'loyalty_service'=>7,
        ...
        'logout_page'=>'http://'.$_SERVER["SERVER_NAME"].'/Kronus_New/cashier.abbott.version/index.php?r=logout', // localhost
        'cut_off'=>'06:00:00',
        ...
        'generate_voucher'=>'http://192.168.30.195/vouchermanagementsystem/VMS/index.php/voucherAPI/generate/',
        'verify_voucher'=>'http://192.168.30.195/vouchermanagementsystem/VMS/index.php/wsvoucher/verify/',
        'use_voucher'=>'http://192.168.30.195/vouchermanagementsystem/VMS/index.php/wsvoucher/use/',
        'cancel_voucher'=>'http://192.168.30.195/vouchermanagementsystem/VMS/index.php/voucherAPI/cancel/',
        'update_voucher'=>'http://192.168.30.195/vouchermanagementsystem/VMS/index.php/voucherAPI/update/',
        'voucher_source'=>3,
        ...
        'Asynchronous_URI'=>'http://'.$_SERVER["SERVER_NAME"].'/Kronus_New/cashier.abbott.version/index.php',
