...
<table id="tbltranshistory" border="1">
   ...
   <tbody id="tbltranshistorybody">
      ...
      <tr class="<?php echo $class; ?>">
         ...
         ?>
         <td class="right"><?php echo toMoney($r['Deposit']) ?></td>
         <td class="right"><?php echo toMoney($r['Reload']) ?></td>
         <td class="right"><?php echo toMoney($r['Withdrawal']); ?></td>
         <td class="right"><?php echo toMoney(($r['Deposit'] + $r['Reload'] - $r['Withdrawal'])); ?></td>      
      </tr>
      <?php
      if($class =='odd')
         $class = 'even';
      ...
      <tr style="background-color: #BCBCBA !important">
          ...
          <td class="right"><?php echo toMoney($deposit); ?></td>
          <td class="right"><?php echo toMoney($reload); ?></td>
          <td class="right"><?php echo toMoney($withdrawal); ?></td>
          <td class="right"><?php echo toMoney($grosshold); ?></td>
      </tr>
      <tr style="background-color: #BCBCBA !important">
          <th colspan="3" >GRAND TOTAL</th>
          <td class="right"><?php echo toMoney($total_rows['totaldeposit']) ?></td>
          <td class="right"><?php echo toMoney($total_rows['totalreload']) ?></td>
          <td class="right"><?php echo toMoney($total_rows['totalwithdrawal']) ?></td>
          <td class="right"><?php echo toMoney(($total_rows['totaldeposit'] + $total_rows['totalreload'] - $total_rows['totalwithdrawal'])); ?></td>       
      </tr>
      <tr style="background-color: #BCBCBA !important">
