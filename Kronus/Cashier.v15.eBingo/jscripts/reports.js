                ...
                success : function(data) {
                    try {
                        ...
                        if(pickdate < compareddate){
                         ...
                         /*  Uncomment for Computation Checking*/
/*                         
                        updateLightbox( '<div style="margin-bottom: 10px; font-weight: bold; width : 700px;"> Transaction History per Site:<br/>Sales </div><table id="salestranssumm" style="width: 650px;"><tr>' +
                                                           '</tr><tr><td style="padding-left: 30px;"><b>Formula</b></td><td style="text-align: right;">' + "((" + RegCash + "+" + RegCoupon + "+" + eSAFECash +  "+" + eSAFECoupon + ") - (" + CashierRedemption + "+" + parseFloat(json.eWalletWithdrawals) + ") -" + SubEncashedTickets + ") -" + parseFloat(json.manualredemptions) + '</td>' +
                                                           '</tr><tr><td style="padding-left:5px;"><b>Cash On Hand</b></td><td style="text-align: right;">' + CashOnHand+ '</td>' +
                                                           '</tr></table>' +
                                                           '<br /><center><input type="button" style="width: 60px; height: 25px;"  value="Close" class="btnClose" /></center>',
                                                           ''          
 ...
 */                      
                            ...
                            //Compute Cash On Hand [ Formula: (((Total Cash from Cashier & Genesis + eSAFE Cash Load) - (Total Cashier Redemption + eSAFE Withdraw)) - Total Encashed Tickets) - Total Manual Redemption ]
                            CompCashOnHand = ((RegCash + RegTicket + RegCoupon + eSAFECash + eSAFETickets + eSAFECoupon) - (CashierRedemption + parseFloat(json.eWalletWithdrawals)) - SubEncashedTickets) - parseFloat(json.manualredemptions);
                            CashOnHand = toMoney(CompCashOnHand,'no');
...
/*                      
                     updateLightbox( '<div style="margin-bottom: 10px; font-weight: bold; width : 700px;"> Transaction History per Site:<br/>Sales </div><table id="salestranssumm" style="width: 650px;"><tr>' +
                                                        '</tr><tr><td style="padding-left: 30px;"><b>Formula</b></td><td style="text-align: right;">' + "((" + RegCash + "+" + RegTicket + "+" + RegCoupon + "+" + eSAFECash + "+"  + eSAFETickets + "+" + eSAFECoupon + ") - (" + CashierRedemption + "+" + parseFloat(json.eWalletWithdrawals) + ") -" + SubEncashedTickets + ") -" + parseFloat(json.manualredemptions) + '</td>' +
                                                        '</tr><tr><td style="padding-left:5px;"><b>Cash On Hand</b></td><td style="text-align: right;">' + CashOnHand+ '</td>' +
                                                        '</tr></table>' +
                                                        '<br /><center><input type="button" style="width: 60px; height: 25px;"  value="Close" class="btnClose" /></center>',
                                                        ''          
