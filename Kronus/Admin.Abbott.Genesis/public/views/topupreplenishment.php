...
<!--                <tr>
                ...
                <tr>
                    <td>Amount</td>
                    <td>
                        <input type="text" class="auto" name="txtamount" id="txtamount" onkeypress="return numberonly(event);" />
                    </td>
                </tr>
                <tr>
                    <td>Date / Time: </td>
                ...
                <tr>
                    <td>Type</td>
                    <td>
                        <select id="cmbreplenishment" name="cmbreplenishment">
                            <option value="-1">Please Select</option>
                            <option value="1">AUB Cash Card</option>
                            <option value="2">BPI Online</option>
                            <option value="3">Cash Replenishment</option>
                        </select>
                    </td>
                </tr>
                <tr>
