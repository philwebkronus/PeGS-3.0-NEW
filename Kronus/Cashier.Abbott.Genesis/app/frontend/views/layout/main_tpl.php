                ...
                <div id="top-header">
                    ...
                    <?php
                        echo Menu::display(array(
                            ...
                            'View Transaction Cashier'=>array('link'=>$this->createUrl('viewtrans/overview'),'act'=>'overview','con'=>'ViewTransaction','attr'=>'desc="View Transactions"'),
                            'View Transaction Virtual Cashier'=>array('link'=>$this->createUrl('viewtrans/overview2'),'act'=>'overview2','con'=>'ViewTransaction','attr'=>'desc="View Transactions"'),
