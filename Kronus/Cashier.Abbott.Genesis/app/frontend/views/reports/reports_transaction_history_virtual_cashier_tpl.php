   ...
   <tbody id="tbltranshistorybody">
     ...
     <?php foreach($rows as $r): ?>
      ...
      <?php foreach($rows2 as $r2): ?>
        <?php $withdrawalcashier2 += $r2['WCashier'];?>
      <?php endforeach; ?>
      <?php 
       /*--- TOTAL ---*/
       ...
       $totalcash = $depositcash + $reloadcash;
       $totaltickets = $depositticket + $reloadticket;
     ...
     <tr><td colspan="12">&nbsp;&nbsp;&nbsp;</td></tr>
      <tr>
          ...
          <td align="center" style="background-color:#BCBCBA">&nbsp;&nbsp;&nbsp;</td>
      ...
      <tr>
          ...
          <td colspan="1" align="right"><?php echo number_format($ticketlist[0]['PrintedRedemptionTickets'],2);?></td>
          <td style="border:0;">* Through Redemption</td>
      </tr>
      <tr>
          <th colspan="1" align="left">Total Active Tickets For The Day</th>
          <td colspan="1" align="right"><?php echo number_format($ticketlist[0]['UnusedTickets'],2);?></td>
      </tr>
<!--      <tr>
          <th colspan="1" align="left">Total Cancelled Tickets</th>
          <td colspan="1" align="right"><?php echo number_format($ticketlist[0]['CancelledTickets'],2);?></td>
      </tr>-->
