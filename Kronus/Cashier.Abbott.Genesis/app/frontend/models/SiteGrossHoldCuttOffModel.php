...
class SiteGrossHoldCuttOffModel extends MI_Model{
    ...
    public function getrunningActiveTickets($date, $enddate, $siteid) {
        ...
        $sql = 'SELECT SUM(RunningActiveTickets) AS RunningActiveTicketsTotal FROM npos.sitegrossholdcutoff WHERE SiteID = :site_id AND DateFirstTransaction >= :startdate AND DateFirstTransaction < :enddate';
