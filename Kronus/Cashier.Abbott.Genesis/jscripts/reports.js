...
//                            page_total_redemption = parseFloat(page_total_redemption) + parseFloat(toInt(json.rows[i].Withdrawal));
                        ...
                        cashonhand = totalcash - (parseFloat(withdrawalcashier2) + parseFloat(json.manualredemptions) + parseFloat(json.ticketlist[0].EncashedTickets));
...
//                         
                        ...
                        cashonhand = parseFloat(totalcash) - (parseFloat(withdrawalcashier) + parseFloat(json.ticketlist[0].EncashedTickets));
