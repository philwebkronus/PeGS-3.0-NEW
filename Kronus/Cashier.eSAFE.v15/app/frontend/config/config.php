...
//    'domain'=>'http://'.$_SERVER["SERVER_NAME"].'/Kronus.UB.New/cashier.eSAFEv15/index.php', // localhost
    // LOGS
    'logs'=>array(
...
//        'filesize'=>1,
	...
	'BGI_ownerID'=>1,
        ...
        'rtg_cert_dir'=>'/var/www/kronus.admin.v15/public/views/sys/config/RTGClientCerts/',
        'logout_page'=>$http . '://'.$_SERVER["SERVER_NAME"].'/index.php?r=logout',
//        'logout_page'=>'http://'.$_SERVER["SERVER_NAME"].'/Kronus.UB.New/cashier.eSAFEv15/index.php?r=logout', // localhost
        'cut_off'=>'06:00:00',
        ...
        'blue'=>600000,
        'red'=>200000,
        'sys_version'=>'kronus.cashier.eSAFE.v15',
