...
class TransactionDetailsModel extends MI_Model{
    ...
    public function getCardDepositPerSite(){
        
    }
    
    public function getCardDepositPerCashier(){
        
    }
    
    public function getCardReloadPerSite(){
        
    }
    
    public function getCardReloadPerCashier(){
