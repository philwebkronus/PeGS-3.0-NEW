    ...
    <div align="center">
        ...
        <div id="senchaexport1" style="background-color: #6A6A6A; padding-bottom: 60px; display: none; width: 1200px;">
           ...
           <input type="button" name="exportExcel" id="exportExcel" value="Export to Excel File" 
                       onclick="window.location.href='process/ProcessRptCashierNodeLogins.php?excel=CashierNodeLogins&DateFrom='+document.getElementById('popupDatepicker1').value+'&DateTo='+document.getElementById('popupDatepicker2').value+'&fn='+document.getElementById('popupDatepicker1').value+'&sord=asc'" style="float: right;"/>
        </div>
    </div>
