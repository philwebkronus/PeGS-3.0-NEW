        ...
        switch($vgetpage)
        {
            case 'UBtrack':
                ...
                if(count($result) > 0)
                {
                    ...
                    $totalGenesisWithdraw = array(0 => 'Grand Genesis Withdrawal',
            ...
            case 'ExportToPDF':
                ...
                $pdf->c_tableHeader2(array(
                        array('value'=>'SiteCode', 'width' => '50px'),
                        array('value'=>'Terminal Code' ,'width' => '60px'),
                        array('value'=>'Service Name'),
                        array('value'=>'Starting Balance'),
                        array('value'=>'Total eSAFE Loads(With Session)'),
                        array('value'=>'Genesis Withdrawal'),
                        array('value'=>'Date Started', 'width' => '140px'),
                        array('value'=>'Date Ended', 'width' => '140px')
                    
//                    'Site Code','Terminal Code','Service Name',
//                    'Starting Balance','Total eSAFE Loads(With Session)','Ending Balance','Genesis Withdrawal','Date Started','Date Ended'
                    ));
                    ...
                    {    
                      ...
                      $vgenesiswithdrawal = $vview['GenesisWithdrawal'];
                       $pdf->c_tableRow2(array(
                          array('value'=>$sitecode,'align'=>'center', 'width' => '50px'),
                          array('value'=>$rterminalCode,'align'=>'center', 'width' => '60px'),
                          array('value'=>$vview['ServiceName'],'align'=>'center'),
                          array('value'=>number_format($vstartbal, 2, '.', ','),'align'=>'right'), 
                          array('value'=>number_format($vesafeloads, 2, '.', ','),'align'=>'right'),
                          array('value'=>number_format($vendbal, 2, '.', ','),'align'=>'right'),
                          array('value'=>$vview['DateStarted'],'align'=>'center', 'width' => '140px'),
                          array('value'=>$vview['DateEnded'],'align'=>'center', 'width' => '140px')
...
//                                           8 => $vview['DateEnded']
                    ...
                    $pdf->html.= '<div style="text-align: left;"><table style="width:35%"><tr>';   
                    $pdf->html.= ' <td>Grand Starting Balance:</td><td align="right">'.number_format($grandstartbal, 2, '.', ',');
                    $pdf->html.= '</td></tr><tr>';     
                    $pdf->html.= ' <td>Grand e-SAFE Loads:</td><td align="right">'.number_format($grandesafeloads, 2, '.', ',');
                    $pdf->html.= '</td></tr><tr>';     
                    $pdf->html.= '<td>Grand End Balance:</td><td align="right">'.number_format($grandendbal, 2, '.', ',');
                    $pdf->html.= '</td></tr><tr>'; 
                    $pdf->html.= ' <td>Grand Genesis Withdrawal:</td><td align="right">'.number_format($grandgenesiswithdraw, 2, '.', ',');
                    $pdf->html.= '</td></tr><tr>'; 
                    $pdf->html.= ' <td>Total Grosshold :</td><td align="right">'.number_format($vgrossholdamt, 2, '.', ',');
                    $pdf->html.= '</td></tr><tr></table></div>';
//                    
//                    $pdf->html.= '<div style="text-align: left;">';
    ...
    elseif(isset($_GET['export']))
    {
        ...
        switch($vgetpage)
        {
            ...
            case 'ExportToPDF':
                ...
                $pdf->SetFontSize(10);
                $pdf->c_tableHeader2(array(
                        array('value'=>'Site Code', 'width' => '40px'),
                        array('value'=>'Terminal Code' ,'width' => '50px'),
                        array('value'=>'ServiceName'),
                        array('value'=>'Deposit'),
                        array('value'=>'Reload'),
                        array('value'=>'Withdrawal'),
                        array('value'=>'Date Started', 'width' => '150px'),
                        array('value'=>'Date Ended', 'width' => '150px'),
                ...
                if(count($result) > 0)
                {
                    ...
                    {    
                      ...
                      $pdf->c_tableRow2(array(
                          array('value'=>$sitecode,'align'=>'center', 'width' => '40px'),
                          array('value'=>$rterminalCode,'align'=>'center', 'width' => '50px'),
                          array('value'=>$vview['ServiceName'],'align'=>'center'),
                          ...
                          array('value'=>$vview['DateStarted'],'align'=>'center', 'width' => '150px'),
                          array('value'=>$vview['DateEnded'],'align'=>'center', 'width' => '150px')
...
//                                             7 => $vview['DateEnded']
                    ...
                    $pdf->html.= '<div style="text-align: left;"><table style="width:30%"><tr>';   
                    $pdf->html.= ' <td>Grand Deposit:</td><td align="right">'.number_format($granddeposit, 2, '.', ',');
                    $pdf->html.= '</td></tr><tr>';     
                    $pdf->html.= ' <td>Grand Reload:</td><td align="right">'.number_format($grandreload, 2, '.', ',');
                    $pdf->html.= '</td></tr><tr>';     
                    $pdf->html.= '<td>Grand Withdrawal:</td><td align="right">'.number_format($grandwithdraw, 2, '.', ',');
                    $pdf->html.= '</td></tr><tr>'; 
                    $pdf->html.= ' <td>Total Grosshold:</td><td align="right">'.number_format($vgrossholdamt, 2, '.', ',');
                    $pdf->html.= '</td></tr><tr></table></div>';
                }
