<?php
$pagetitle = "User Based Manual Redemption Override";
    ...
    if (count($vaccesspages) == $vctr) {
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                        ...
                        jQuery.ajax(
                                {
                                    ...
                                    type: 'post',
                                    data: {page: function() {
                                            return "ManualRedemptionOverride";
                                        },
                                        txtterminal: function() {
                                            return $("#txtterminal").val();
                                        },
                                        terminalcode: function() {
                                            return $("#terminalcode").val()
                                        },
                                        txtservices: function() {
                                            return $("#txtservices").val();
                                        },
                                        cmbterminal: function() {
                                            return $("#cmbterminal").val();
                                        },
                                        cmbsite: function() {
                                            return $("#cmbsite").val();
                                        },
                                        chkbalance: function() {
                                            return $("#chkbalance").val();
                                        },
                                        txtterminalid: function() {
                                            return $("#txtterminalid").val();
                                        },
                                        txtserviceid: function() {
                                            return $("#txtserviceid").val();
                                        },
                                        txtticketub: function() {
                                            return $("#txtticketub").val();
                                        },
                                        txtamount2: function() {
                                            return $("#txtamount2").val();
                                        },
                                        hdnamtwithdraw: function() {
                                            return $("#hdnamtwithdraw").val();
                                        },
                                        txtremarksub: function() {
                                            return $("#txtremarksub").val();
                                        },
                                        txtmid: function() {
                                            return $("#txtmid").val();
                                        },
                                        ...
                                        txtusermode: function() {
                                            return $("#txtusermode").val();
                                        },
                 ...
                 *           information
                 */
                $('#btnSubmitMemberDetails').click(function()
                {
                    document.getElementById('loading').style.display = 'none';
                    document.getElementById('member-light3').style.display = 'none';
                    document.getElementById('light3').style.display = 'block';

                    var url = 'process/ProcessTopUp.php';
                    //call method to display card and balance information
                    getCasinoBalance(url);
                                            ...
                                            success: function(data)
                                            {
                                                if (data == "No User Based.") {
                                                    ...
                                                    $.each(data, function(i, user)
                                                    {
                                                        $('#loading').hide();
                                                        document.getElementById('loading').style.display = 'none';
                                                        document.getElementById('member-light3').style.display = 'block';
                                                        document.getElementById('fade3').style.display = 'block';
            ...
            <form method="post" action="process/ProcessTopUp.php" id="frmredemption" class="frmmembership" name="frmcs">
                ...
                <div id="cont">
                    <div id="light1" class="white_content" oncontextmenu="return false" style="width: 308px; height:212px;">
                        <div class="close_popup" id="btnClose" onclick="document.getElementById('light1').style.display = 'none';
                        ...
                        <input type="button" id="btnCancel" value="Cancel" style="float: right;" onclick="document.getElementById('light1').style.display = 'none';
                                document.getElementById('fade').style.display = 'none'" />
                        <input type="button" id="btnok" value="OK" style="margin-left: 130px; display: none;" onclick="document.getElementById('light1').style.display = 'none';
                                document.getElementById('fade').style.display = 'none'" />
                    ...
                    <div id="light4" class="white_content" oncontextmenu="return false" style="width: 308px; height:212px;">
                        <div class="close_popup" id="btnClose" onclick="document.getElementById('light4').style.display = 'none';
                                document.getElementById('fade4').style.display = 'none';"></div>
                        <br />
                        <br />
                        <br />
                        ...
                        <br />
                        <br />
                        <input type="button" value="Ok" style="float: right;" onclick="document.getElementById('light4').style.display = 'none';
                    ...
                    <div id="light2" class="white_content" oncontextmenu="return false" style="width: 308px; height:212px;">
                        ...
                        <input type="hidden"  name="Withdraw" value="WithdrawUB" />
                        <input type="button" id="btnCancel" value="Cancel" style="float: right;" onclick="document.getElementById('light2').style.display = 'none';
                                document.getElementById('fade').style.display = 'none'" />
                        <input type="button" id="btnok" value="OK" style="margin-left: 130px; display: none;" onclick="document.getElementById('light2').style.display = 'none';
                                document.getElementById('fade').style.display = 'none'" />
                        </form>
                    ...
                    <!---------------------------MEMBER INFORMATION----------------------------->
                    <div id="member-light3" class="white_page">
                        <div class="close_popup" id="btnClose" onclick="document.getElementById('member-light3').style.display = 'none';
                                document.getElementById('fade3').style.display = 'none';"></div>
                        <input type="hidden" name="txtsitecode" id="txtsitecode" />
                        <table id="memberdata" class="tablesorter" align="center">
                            <tr>
                                <td>&nbsp;</td>
                            </tr>
                            <tr align="right">
                        ...
                        <div style="float:right">
                            <input type="button" id="btnSubmitMemberDetails" value="Submit" style="margin-right: 5px;" />
                            <input type="button" id="btnok" value="Cancel" style="" onclick="document.getElementById('member-light3').style.display = 'none';
                                    document.getElementById('fade3').style.display = 'none'" />      
                        </div>
                    </div>
                    <!----------------------------------------------------------------------------------->
                    ...
                    <div id="light3" class="white_page">
                        <div class="close_popup" id="btnClose" onclick="document.getElementById('light3').style.display = 'none';
                                document.getElementById('fade3').style.display = 'none';"></div>
                        <input type="hidden" name="txtsitecode" id="txtsitecode" />
                        ...
                        <br />
                        <div align="center">
                            <input type="button" id="btnok" value="Cancel" style="margin-left: 600px;" onclick="document.getElementById('light3').style.display = 'none';
                                    document.getElementById('fade3').style.display = 'none'" />
                        </div>        
                    </div>
                    <!----------------------------------------------------------------------------------->
                    ...
                    <div id="lightamt" class="white_page">
                        <div class="close_popup" id="btnClose" onclick="document.getElementById('lightamt').style.display = 'none';
                                document.getElementById('fade3').style.display = 'none';"></div>
                        <input type="hidden" name="txtsitecode" id="txtsitecode" />
                        ...
                        <div style="float:right">
                            ...
                            <input type="button" id="btnok" value="Cancel" style="" onclick="document.getElementById('lightamt').style.display = 'none';
                                    document.getElementById('fade3').style.display = 'none'" />      
                        </div>
                    </div>
                    <!-------------------------------------------------------------------------------------->
                    ...
                    <div id="lightub" class="white_content" oncontextmenu="return false" style="width: 308px; height:312px;">
                        <div class="close_popup" id="btnClose" onclick="document.getElementById('fade3').style.display = 'none';
                                document.getElementById('lightub').style.display = 'none';
                                document.getElementById('fadeub').style.display = 'none';"></div>
                        <input type="hidden"  name="Withdraw" value="WithdrawUB" />
                        <br />
                        <div id="userdata"></div>
                        <input type="hidden" id="txtamount2" name="txtamount2"/> 
                        ...
                        <!------------------------------------------------------------------------------>
                        <input type="hidden"  name="Withdraw" value="WithdrawUB" />
                        <input type="button" id="btnCancel" value="Cancel" style="float: right;" onclick="document.getElementById('fade3').style.display = 'none';
                                document.getElementById('lightub').style.display = 'none';
                                document.getElementById('fadeub').style.display = 'none'" />
                        <input type="button" id="btnok" value="OK" style="margin-left: 130px; display: none;" onclick="ddocument.getElementById('lightub').style.display = 'none';
                                document.getElementById('fadeub').style.display = 'none'" />
                        </form>
