...
<script type="text/javascript">
        ...
        $('#cmbterminal').live('change', function()
        {
            ...
            if(terminal != "-1")
            {
                ...
                jQuery.ajax(
                {
                    ...
                    data: 
                    {
                        cmbterminal: function(){return jQuery("#cmbterminal").val();}
                    },
                    dataType: 'json',
                    success: function(data)
                    {
        ...
        $('#btnWithdrawub').click(function()
        {
            ...
            else
            {
                ...
                jQuery.ajax(
                {
                    ...
                    data: 
                    {
                        page: function(){ return "Withdraw";},
                        //COMMENT OUT CCT 07/13/2018 BEGIN
                        ...
                        //COMMENT OUT CCT 07/13/2018 END
                    },
                    dataType : 'json',  
                    success : function(data)
                    {
         ...
         /**
         * Onclick : Displays the actual balance and membership card information
         */
    ...
    //function for redeem button : basically hides card information lightbox and shows withdraw form
    ...
    function getMembershipAndCasinoInfo(url)
    {
        ...
        jQuery.ajax(
        {
            ...
            data: 
            {
                page: function(){ return "GetLoyaltyCard";},
                chkbalance: function() {return $("#chkbalance").val();},
                txtcardnumber: function(){return jQuery("#txtcardnumber").val();}
            },
            dataType : 'json',
            success : function(data)
            {
                $.each(data, function(i,user)
                {
                    ...
                    else
                    {
                        document.getElementById('loading').style.display='block';
                        document.getElementById('fade3').style.display='block';
                        /* if membership card is valid, get casino array then display pop-up box 
                        * showing the card information as well as its actual balance */
                        jQuery.ajax(
                        {
                            url: url,
                            type: 'post',
                            data: 
                            {
                                page: function(){ return "GetCasino";},
                                txtterminal: function() {return $("#txtterminal").val();},
                                terminalcode: function() {return $("#terminalcode").val()},
                                txtservices: function() {return $("#txtservices").val();},
                                cmbterminal: function() {return $("#cmbterminal").val();},
...
<div id="workarea"> 
    ...
    <form method="post" action="process/ProcessTopUp.php" id="frmredemption" class="frmmembership" name="frmcs">
        ...
        <input type="hidden" name="txtserviceid" id="txtserviceid" />
        <input type="hidden" name="txtmid" id="txtmid" />
        <table>
            <tr>
                <td>Card Number<input type="input" size="30"  id="txtcardnumber" class="txtmembership" name="txtcardnumber" maxlength="30" size="30" onkeypress="return loyaltycardnumber(event);"/>
