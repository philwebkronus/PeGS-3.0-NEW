...
class PCWSAPI{
    ...
    public function Deposit($cardnumber, $serviceid, $paymenttype, $amount, $siteid, $aid, $systemusername, $tracenumber, $referencenumber){
        ...
        $postdata = json_encode(array('ServiceID'=>$serviceid, 'CardNumber'=>$cardnumber, 'Amount'=>$amount, 'PaymentType'=>$paymenttype, 'SiteID'=>$siteid, 'AID'=>$aid,
                                                                            'SystemUsername'=>$systemusername, 'AccessDate'=>$accessdate, 'Token'=>$tkn, 'TraceNumber'=>$tracenumber, 'ReferenceNumber'=>$referencenumber));
