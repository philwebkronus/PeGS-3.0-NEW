...
<div id="tm-reload-form">
    ...
    <div>
        <form id="frmredeem">
            <input id="UnlockTerminalFormModel_terminal_id" name="UnlockTerminalFormModel[terminal_id]" type="hidden" value="<?php echo $terminal_id; ?>" />
            <table>
                <tr>
                    <th>Show details</th>
                ...
                <tr>
                    <th>BALANCE:</th>
                    <td><span id="lock_terminal_balance">PhP <?php echo $data['amount']; ?></span></td>
                </tr>
                <tr>
                    <th><input id="btnLock" type="button" value="Submit" /></th>
