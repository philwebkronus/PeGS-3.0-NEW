...
class VoucherTicketAPIWrapper
{
    ...
    */
     ...
     * @return str | array
     */
    public function addTicket($terminalName, $amount, $aid, $source, $cardnumber, $purpose, $stackerBatchID, $voucherTicketBarcode, $trackingId = ''){
        
        $this->_URI = Yii::app()->params['get_voucher'];
     ...
     * @return str | array
     */
    public function useVoucher($terminalName, $vouchercode, $aid, $source, $trackingID, $cardNumnber){
        ...
        $postData = json_encode(array('AID'=>$aid,
                                      ...
                                      'Source'=>$source,
                                      'MembershipCardNumber'=>$cardNumnber));
