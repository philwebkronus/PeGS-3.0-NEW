...
class MicrogamingAPI
{
    ...
    public function AddAccount($accountNumber,
                               ...
                               $bettingProfileId)
    {
        return $this->_soapClient->call( 'AddAccount', array('accountNumber' => $accountNumber,
                                                                'password' => $password,
                                                                'firstName' => $firstName,
                                                                'lastName' => $lastName,
                                                                'currency' => $currency,
    ...
    {
        return $this->_soapClient->call( 'Deposit', array( 'accountNumber' => $accountNumber, 'amount' => $amount, 'currency' => $currency ) );
    }
    
    public function GetAccountBalance( $accountNumber )
    {
        return $this->_soapClient->call( 'GetAccountBalance', array( 'delimitedAccountNumbers' => $accountNumber ) );        
    }
    ...
    {
        return $this->_soapClient->call( 'Withdrawal', array( 'accountNumber' => $accountNumber, 'amount' => $amount ) );
    }
}
