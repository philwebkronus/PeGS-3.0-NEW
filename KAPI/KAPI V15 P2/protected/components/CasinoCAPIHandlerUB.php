...
class CasinoCAPIHandlerUB
{
    ...
    public function __construct( $gamingProvider, $configuration )
    {
        ...
        $this->_URI2 = $configuration[ 'URI_PID2' ];
        ...
        else if ( $this->_gamingProvider == self::RTG2 )
        {
            ...
            if($configuration['APIType'] == 2){
                    ...
                    $this->_API = new RealtimeGamingUBAPIWrapper( $this->_URI2, RealtimeGamingUBAPIWrapper::PLAYER_API, $certFilePath, $keyFilePath, $this->_isCaching );
            }
                             ...
                             $event_id = '', $transaction_id = '', $locatorName = '' )
    {
        ...
        {
            return $this->_API->Deposit( $login, $amount, $tracking1, $tracking2, $tracking3, $tracking4, $locatorName );
        }
        else if ( $this->_gamingProvider == self::PT ) 
        {
