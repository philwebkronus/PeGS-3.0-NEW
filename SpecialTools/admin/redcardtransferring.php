                ...
                <div id="results" style="display: none;">
                    <div id="playerprofiledetails" style="display: block;">
                        ...
                        <table id="tblplayerdetails">
                            ...
                            <tr><td style="width: 200px;">Life Time Points</td><td id="tblltpoints"></td></tr>
                            <tr><td style="width: 200px;">Current Points</td><td id="tblcpoints"></td></tr>
                            <tr><td style="width: 200px;">Redeemed Points</td><td id="tblrpoints"></td></tr>
                            <tr><td style="width: 200px;">Bonus Points</td><td id="tblbpoints"></td></tr>
                        </table>
                        <?php echo "$hdnMID"; ?>
                        </div>
                        <div style="float: left">
