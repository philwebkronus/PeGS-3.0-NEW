...
//                                    $.checkPin(tmpMid);
    ...
    $.checkUBSession = function(option3) {
        ...
        $.post("../Helper/lock.php",
            ...
            tmpTransactionSummaryID = data['TransactionSummaryID']; // CCT - added from Prod                                                                 

            if (!(tmpTransactionSummaryID === undefined || tmpTransactionSummaryID === null || tmpTransactionSummaryID === 'undefined' || tmpTransactionSummaryID === 'null' || tmpTransactionSummaryID === '')) { // CCT - added from Prod
                if (!(tmpUBserviceLogin === '' || tmpUBserviceLogin === 0 || tmpUBserviceLogin === null || tmpUBserviceLogin === 'null' || tmpUBserviceLogin === undefined || tmpUBserviceLogin === 'undefined')) {
                    ...
                    if (option3 == 0) { //launch classic game client.
                        if (tmpUBserviceLogin != "0") {
                            if (tmpServiceID != "19") {
                                $.launchGame(tmpServiceID + ".1", tmpUBserviceLogin, tmpUBHashedServicePassword, null, null);
                            } else {
                                $.launchGame(tmpServiceID, tmpUBserviceLogin, tmpUBHashedServicePassword, null, null);
                            }
                        } else {
                            $.checkLandingPage();
                        }
                        ...
                        if (tmpUBserviceLogin != "0") {
                            $.launchGame(tmpServiceID + ".2", tmpUBserviceLogin, tmpUBHashedServicePassword, null, null);
                        } else {
                            $.checkLandingPage();
                        }
                    } else { //end session.
...
//                            alert("2: " + userMode + " " + serviceGroupID);     //****
                            ...
                            $.ajax({
                                ...
                                async: true,
                                data: {fn: function() {
                                        return 'getTerminalSiteClassification';
                                    },
                                    TerminalCode: function() {
                                        return terminalCode;
                                    }},
