...
//        'file:///C:/iGaming/Casino/vibrantvegas/casinogame.exe',
    ...
    'logpath' => '/var/www/launchpad.esafe.v15.ebingo/logs/',
    'projectDIR'=>'launchpad.eSAFEv15.02',
    'systemUsername'=>'lliter',
    'systemCode'=>'4881052',
    'uriForceLogout'=>'https://pcws.esafe.v15.02.dev.local/index.php/pcws/forcelogout',
    'uri_changePin'=>'https://pcws.esafe.v15.02.dev.local/index.php/pcws/changepin',
    'uri_startSession'=>'https://pcws.esafe.v15.02.dev.local/index.php/pcws/unlock',
    'uri_checkPin'=>'https://pcws.esafe.v15.02.dev.local/index.php/pcws/checkpin',
    'maxPinAttempts'=>3,
    'LPnonewalletURL' => 'http://localhost/trunk/launchpad.eSAFEv15.ebingo/views/lobby.php', //launchpad with e-BINGO integration
    'LPewalletURL' => 'http://localhost/trunk/launchpad.eSAFEv15.02/views/lobby.php', //launchpad without e-BINGO integration
    'isAllowed' => true,
    'isDetectTerminalType' => true, //if true, detect Launchpad version using Site Classification then redirect 
    'IsALLeSAFE' => false,
    'TerminalTstCode' => 'ICSA-TSTID61',
);
