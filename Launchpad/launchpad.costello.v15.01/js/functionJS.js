            ...
            $.post("../Helper/lock.php",
                {
                    ...
                    option:1
                        ...
                        tmpTransactionSummaryID = data['TransactionSummaryID'];                                                                 
                                                
                        if(!(tmpTransactionSummaryID === undefined || tmpTransactionSummaryID === null || tmpTransactionSummaryID === 'undefined' || tmpTransactionSummaryID === 'null' || tmpTransactionSummaryID === '' )){
