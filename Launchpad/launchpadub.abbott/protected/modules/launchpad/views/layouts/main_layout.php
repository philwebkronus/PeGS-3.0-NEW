...
<html>
    ...
    <body>
        ...
        <object id="axPSMAC" name="axPSMAC" style="display:none" classid="CLSID:A8FC5B1D-56F1-4DB1-8C87-811C91497315" 
                codebase="<?php echo LPConfig::app()->params['cabFile']; ?>"></object>      
    </body>
</html>