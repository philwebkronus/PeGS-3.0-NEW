...
Yii::import('application.modules.launchpad.components.RealtimeGamingUBAPIWrapper');
...
class CasinoApi
{
    ...
    {
        $ServiceGroupName =  strtolower(LPRefServices::model()->getServiceGroupName($serviceID));
