...
//            'rtg','mg','pt',
    ...
    'db'=>array(
        'connectionString' => 'mysql:host=172.16.102.158;dbname=nposv3',
        'emulatePrepare' => true,
        'username' => 'genesisqaconn',
        'password' => 'genesisqaconnpass',
        'charset' => 'utf8',
    ),
    
    //Connection for membership
    'db2'=>array(
        'connectionString' => 'mysql:host=172.16.102.158;dbname=membership',
        'emulatePrepare' => true,
        'username' => 'genesisqaconn',
        'password' => 'genesisqaconnpass',
        'charset' => 'utf8',
...
//        'file:///C:/iGaming/Casino/vibrantvegas/casinogame.exe',
    ...
    //'rssFeedUrl'=>'http://'.$_SERVER["SERVER_NAME"].'/Launchpad_UB/index.php?r=managerss/rss/feed',
    //'cabFile'=>'http://'.$_SERVER["SERVER_NAME"].'/Launchpad_UB/controls/PEGS.Terminal.ActiveX.cab',
);
