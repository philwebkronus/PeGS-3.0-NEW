...
class LPTerminalSessions extends LPModel
{
    ...
    public function updateCurrentServiceID($terminalID,$serviceID, $password, $hashedpassword, $servicelogin, $usermode) 
    {
        ...
        $data = array(
            ...
            ':hashedservicepassword'=>$hashedpassword,
    ...
    public function getMID($terminalCode) 
    {
        ...
        $row=$command->queryRow(true, array(':terminalCode'=>$terminalCode));
        if(!$row) {
            $this->log("Can't get UB Card ID", 'launchpad.models.LPTerminalSessions');
            throw new CHttpException(404, "Can't get UB Card ID");
        }
