...
//        'file:///C:/iGaming/Casino/vibrantvegas/casinogame.exe',
    ...
    'rssFeedUrl'=>'http://'.$_SERVER["SERVER_NAME"].'/launchpad_gtc/index.php?r=managerss/rss/feed',
    'cabFile'=>'http://'.$_SERVER["SERVER_NAME"].'/launchpad_gtc/controls/PEGS.Terminal.ActiveX.cab',
);
