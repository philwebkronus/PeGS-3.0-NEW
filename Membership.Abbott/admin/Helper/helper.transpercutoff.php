...
if(isset($_POST['Sites']) && $_POST['Sites'] != ''){
    ...
    $todate = $_POST['toDateverified']." ".App::getParam("cutofftimeend");
    ...
    $limit = (int)$limit;
        ...
        if($count > 0)
        {
             ...
             {           
                 ...
                 $cardnumber = $vview['LoyaltyCardNumber'];
                 if (empty($cardnumber)) {
                    continue;
                  }
                $cardid = $_MemberCards->getMID($cardnumber);
                ...
                $result2 = $_TransactionSummary->getTransSummaryperCard($site, $fromdate, $todate, $cardnumber);
                ...
                $responce->rows[$i]['id']=$cardnumber;
                $responce->rows[$i]['cell']=array($cardnumber,$vstatus,number_format($arrgrand['Deposit'],2),
