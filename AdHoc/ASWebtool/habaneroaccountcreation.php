...
if ($_SERVER['REMOTE_ADDR']) {
    if (in_array(htmlspecialchars(trim($_SERVER['REMOTE_ADDR'])), $IPrestriction)) {
        ...
        if (!empty($_SESSION['loggedin'])) {
            //get all sites
            $getAllSites = $PDO->getActiveSites();
            ?>


            <html>
                <head>
                    <title> Habanero Terminal Accounts Creation Web Tool </title>
                ...
                <body style="position: static;">
                    ...
                    <div style="width: 100%; margin-top : 50px;">
                        <div style="float:left; width: 49%; border: 1px solid black;">
                            <legend>
                                <center><h1>Habanero Terminal Accounts Creation Web Tool</h1></center>
                                <hr><br>
                                <table>
                                    <tr>
                                        <td><b>*Site : </b></td>
            ...
            <script type="text/javascript">
                $(document).ready(function() {
                    ...
                    function get_contents() {
                        $.get('FileReadHabaneroAccountCreation.php?tail', function(data) {
                            $('#contents').html(data);
                        });
                    ...
                    $('.submit-button').click(function() {
                        ...
                        if (SiteID !== null && SiteCode !== null && TerminalIDs !== null && TerminalCodes !== null && CasinoID !== null && CasinoID !== '') {
                            ...
                            if (TerminalIDs.length > max_terminal) {
                                ...
                                var answer = confirm("Are you sure you want to create habanero account for " + CasinoCode + " on the following terminals? \n" + ret);
                                if (answer) {
                                    $('.ajax-loader').css("visibility", "visible");
                                    $.ajax({
                                        url: 'process/ProcessCreateHabaneroAccount.php',
                                        method: "POST",
                                        data: {
