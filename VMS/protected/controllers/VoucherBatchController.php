...
//        }
    ...
    public function actionGenerate() {
        ...
        if ($sessioncount == 0) {
            ...
            if (isset($_POST['Quantity']) && is_numeric($_POST['Quantity']) && isset($_POST['Amount']) && is_numeric($_POST['Amount']) && isset($_POST['Validity']) && is_numeric($_POST['Validity'])) {
        ...
        if ($sessioncount == 0) {
            ...
            if (Yii::app()->request->IsAjaxRequest) {
                ...
                if (isset($_POST['DateFrom']) && isset($_POST['DateTo']) && isset($_POST['Status'])) {
                    ...
                    if (isset(Yii::app()->session['dateFrom']) && isset(Yii::app()->session['dateTo']) && isset(Yii::app()->session['status'])) {
