...
<?php
    ...
    <center>
        <table style="border: 2px #DEDEDE solid; min-width: 30%; max-width: 50%;">
            ...
            <tr><td style="border-bottom: 0.1px #DEDEDE solid; background: #D0E3EF;"></td><td colspan="2" style="border-bottom: 0.1px #DEDEDE solid; border-right: 0.1px #DEDEDE solid; background: #D0E3EF;">Active Tickets</td>
