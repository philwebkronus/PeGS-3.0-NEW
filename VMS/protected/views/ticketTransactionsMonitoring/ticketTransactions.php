...
//        echo Yii::app()->session['transactiondate']." to ".$vdate. " ".Yii::app()->params['cutofftimeend'];
    ...
    <h4><u>TICKET TRANSACTIONS PER CUT OFF SUMMARY</u></h4>
        ...
        <table style="border: 2px #DEDEDE solid; min-width: 30%; max-width: 50%;">
            ...
            <tr><td style="border-bottom: 0.1px #DEDEDE solid; background: #D0E3EF;"></td><td colspan="2" style="border-bottom: 0.1px #DEDEDE solid; border-right: 0.1px #DEDEDE solid; background: #D0E3EF;">Unused (Active) Tickets</td>
            ...
            <tr><td style="background: #D0E3EF;"></td><td style="background: #D0E3EF;"></td><td style="border-right: 0.1px #DEDEDE solid; background: #D0E3EF;">Void</td>
