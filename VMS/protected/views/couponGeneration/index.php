   ...
   //document.onmouseup = mousehandler;
    ...
    function loadCouponGrid(batchID, couponcode, status, transdatefrom, transdateto, site, terminal, source, promoname) {
        ...
        jQuery("#list2").jqGrid({
             ...
             colNames:['Batch ID', 'Coupon ID', 'Coupon Code', 'Amount', 'Distribution Type', 'Creditable?', 'Date Generated', 'Generated By',  'Valid From Date', 'Valid To Date', 'Status', 'Site',  'Terminal', 'Source', 'Transaction Date', 'Promo Name'],
             colModel:[
