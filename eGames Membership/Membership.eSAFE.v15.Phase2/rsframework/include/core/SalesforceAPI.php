...
class SalesforceAPI extends APIAbstract {
     ...
     */
    public function __construct($instance_url,$version, $client_id, $client_secret, $record_type, $return_type = self::RETURN_OBJECT)
...
//    }
   public function create_account($lname, $fname, $bdate, $salutation, $playertype, $cardnumber, $instance_url, $access_token) {
    ...
    $content = json_encode(array("FirstName" => $fname, "LastName" => $lname, "Type_of_Player__c" => $playertype, "Birthdate__c" => $bdate, "Salutation" => $salutation, "Membership_Card_Number__c" => $cardnumber, "RecordTypeId" => $this->record_type)); //prod: '012o0000000p8uHAAQ' staging: '01228000000JV06AAG'
...
//    }
    ...
    if ($membstatus != null)
    {
        $params['Inactive__pc'] = $membstatus;// TRUE or FALSE
    }
    if ($membtype != null)
    {
