        ...
        if($source == 1){
            ...
            if(App::getParam('PointSystem') == 2) {
                ...
                if($api['GetCompPoints']['ErrorCode'] == 0)
                {
                    ...
                    $_Log->logEvent(AuditFunctions::GET_COMP_POINTS, 'MID:' . $MID .'CardNumber :'.$redemptiondata["CardNumber"]. ': Successful', array('ID' => $_SESSION['userinfo']['AID'], 'SessionID' => $_SESSION['userinfo']['SessionID']));
                ...
                else
                {
                    ...
                    $_Log->logEvent(AuditFunctions::GET_COMP_POINTS, 'MID:' . $MID .'CardNumber :'.$redemptiondata["CardNumber"].' Message: '.$errMsg.': Failed', array('ID' => $_SESSION['userinfo']['AID'], 'SessionID' => $_SESSION['userinfo']['SessionID']));
                }
                //$PlayerPoints = $api['GetCompPoints']['CompBalance'];
            }
            else {
            ...
            if(App::getParam('PointSystem') == 2 ){
                ...
                {
                    $PlayerPoints = $api['GetCompPoints']['CompBalance'];
                    $_Log->logEvent(AuditFunctions::GET_COMP_POINTS, 'MID:' . $redemptiondata["MID"] .'CardNumber :'.$redemptiondata["CardNumber"]. ': Successful', array('ID' => $_SESSION['userinfo']['AID'], 'SessionID' => $_SESSION['userinfo']['SessionID']));
                ...
                else
                {
                    $PlayerPoints = 0;
                    $errMsg = $api['GetCompPoints']['TransactionMessage'];
                    $_Log->logEvent(AuditFunctions::GET_COMP_POINTS, 'MID:' . $redemptiondata["MID"] .'CardNumber :'.$redemptiondata["CardNumber"].' Message: '.$errMsg.': Failed', array('ID' => $_SESSION['userinfo']['AID'], 'SessionID' => $_SESSION['userinfo']['SessionID']));
                }
            }
            else {
                $PlayerPoints = $_MemberCards->getCurrentPointsByCardNumber($redemptiondata["CardNumber"]);
