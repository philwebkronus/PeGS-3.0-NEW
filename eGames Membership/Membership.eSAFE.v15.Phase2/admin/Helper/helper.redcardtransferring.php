                            ...
                            if (!App::HasError()) {
                                ...
                                if (!App::HasError()) {
                                    ...
                                    if (!App::HasError()) {
                                        ...
                                        $sRecordType = App::getParam('sRecordType');

                                        // get SalesForce ID
                                        $SFID = $_MemberInfo->getSF($MID);
                                        if ($SFID != '0') {
                                            ...
                                            if ($sfSuccessful) {
                                                ...
                                                $isUpdated = $sfapi->update_account($SFID, null, null, null, $newcard, null, null, $newBaseUrl, $accessToken); //changed $firstname and $lastname to null 07282015 mcs
                                                //return 1;
                                            } else {
                                                //return 0;
                                            }
                                        }
                                        //end SF push 09292015
