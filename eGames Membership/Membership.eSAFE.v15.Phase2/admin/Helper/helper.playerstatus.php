...
$isBirthdateNotEmpty = ($birthdate != '') ? true : false;
$isTxtSearchNotEmpty = ($txtSearch != '') ? true : false;
...
if (isset($_POST['pager'])) {
    ...
    if ($pager == 'GetBanUnban') {
        ...
        if (isset($_POST['txtSearch']) && $_POST['txtSearch'] != '' || isset($_POST['birthdate']) && $_POST['birthdate'] != '') {
            ...
            if ($validate->validateAlphaSpaceDashAndDot($searchValue) == true && $isBirthdateNotEmpty == false) {
                    ...
                    if ($count == 1) {
                        ...
                        if (isset($cardInfo[0])) {
                            ...
                            switch ($cardInfo[0]['Status']) {
                                case 1: $statusvalue = 'Active';
                                    break;
                                case 2: $statusvalue = 'Suspended';
                                    break;
                                case 3: $statusvalue = 'Locked';
                                    break;
                                case 4: $statusvalue = 'Locked';
                                    break;
                                case 5: $statusvalue = 'Banned';
                                    break;
                                case 6: $statusvalue = 'Terminated';
                                    break;
                                default: $statusvalue = 'Card Not Found';
                                    break;
                            }
            ...
            } elseif ($isBirthdateNotEmpty == true && $isTxtSearchNotEmpty == false && $validate->validateDate($birthdate) == true) {

                $result = $_MemberInfo->getMemberInfoByBirthdateSP($birthdate);
            ...
            } elseif ($isBirthdateNotEmpty == true && $isTxtSearchNotEmpty == true && $validate->validateAlphaSpaceDashAndDot($searchValue) == true && $validate->validateDate($birthdate) == true) {

                $result = $_MemberInfo->getMemberInfoByNameBirthdateSP($searchValue, $birthdate);
