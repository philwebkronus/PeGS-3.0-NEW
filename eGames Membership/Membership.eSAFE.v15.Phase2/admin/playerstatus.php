...
$pagetitle = "Player Banning/Unbanning";
...
$txtSearch->CssClass = 'custom[emailAlphanumeric]]';
...
$dtBirthDateBan = new DatePicker("dtBirthDateBan", "dtBirthDateBan", "Birth Date: ");
$dtBirthDateBan->MaxDate = $dsmaxdate->CurrentDate;
$dtBirthDateBan->MinDate = $dsmindate->CurrentDate;
$dtBirthDateBan->ShowCaption = false;
$dtBirthDateBan->YearsToDisplay = "-100";
$dtBirthDateBan->Args = 'placeholder="Select Birthdate"';
$dtBirthDateBan->isRenderJQueryScript = true;
$dtBirthDateBan->Size = 15;
$fproc->AddControl($dtBirthDateBan);
    ...
    $(document).ready(function() {
        ...
        function getPlayerDetails(txtSearch)
        {
            ...
            jQuery("#playerstatus").jqGrid({
                ...
                viewrecords: true,
                sortorder: "asc",
                caption: "Player Banning/Unbanning"
            });
                        ...
                        buttons: {
                            "Submit": function() {
                                if ($("#updatestatus").validationEngine("validate")) {
                                    ...
                                    function(data) {
                                        if (data != "Player Banning/Unbanning: Transaction Successful.") {
    ...
    $(document).ready(
            function()
            {
                ...
                $("#txtSearch").change(function() {
                    if ($("#txtSearch").val() === "" && $("#dtBirthDateBan").val() === "")
                    {
                ...
                $("#dtBirthDateBan").click(function() {
                    $("#dtBirthDateBan").change();
                    if ($("#dtBirthDateBan").val() === "")
                    {
                        $("#dtBirthDateBan").val("");
                    }
                });
                $("#dtBirthDateBan").keyup(function() {
                    $("#dtBirthDateBan").change();
                    $("#btnSearch").removeAttr("disabled");
                });
                $("#dtBirthDateBan").blur(function() {
                    $("#dtBirthDateBan").change();
                });
                $("#dtBirthDateBan").change(function() {
                    if ($("#dtBirthDateBan").val() === "" && $("#txtSearch").val() === "")
                    {
                        $("#btnSearch").attr("disabled", "disabled");
                        $("#dtBirthDateBan").val("");
                        $("#txtSearch").val("");
    ...
    <div class="maincontainer">
        ...
        <div class="content">
            ...
            <div class="searchbar formstyle">
                <?php echo $txtSearch; ?><?php echo $dtBirthDateBan; ?>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                <?php echo $btnSearch; ?><?php echo $btnClear; ?>
            </div>
            <br />
