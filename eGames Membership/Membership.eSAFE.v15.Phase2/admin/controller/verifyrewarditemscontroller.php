...
$txtSerialCode->Args = 'placeholder="Enter Serial Code"onkeypress="javascript: return numberonly(event)"';
...
$txtSecurityCode->Args = 'placeholder="Enter Security Code"onkeypress="javascript: return AlphaNumericOnly(event)"';
