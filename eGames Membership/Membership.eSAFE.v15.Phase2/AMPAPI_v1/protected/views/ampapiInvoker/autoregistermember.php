<div class="form wide" style="margin-left: 20px;">
    <br />
    <h1>Auto Member Registration</h1>
    <br />
    ...
    <div class="row">
        <?php echo CHtml::label('CivilStatus', 'CivilStatus'); ?>
        <?php echo CHtml::textField('CivilStatus'); ?>
    </div>

    <div class="row">
        <?php echo CHtml::label('RegisterFor', 'RegisterFor'); ?>
        <?php echo CHtml::textField('RegisterFor'); ?>
    </div>

    <div class="row">
        <?php echo CHtml::label('UBCard', 'UBCard'); ?>
        <?php echo CHtml::textField('UBCard'); ?>
    </div>
    ...
    <div class="row">
        <?php echo CHtml::label('SiteID', 'SiteID'); ?>
