...
class MPapiInvokerController extends Controller {
    ...
    private function _resetPin($txtcardnumber) {
        $postdata = CJSON::encode(array('CardNumber' => $txtcardnumber));
        $result = $this->SubmitData(Yii::app()->params['urlMPAPI'] . 'resetPin', $postdata);
