...
class ValidateTPSessionIDModel {
    ...
    public function validateTPSessionID($TPSessionID){
        $sql = 'SELECT COUNT(acs.AID) as Count,a.UserName,acs.AID, acs.DateCreated FROM accounts a, accountsessions acs WHERE acs.SessionID=:TPSessionID AND acs.AID=a.AID AND a.UserAccessTypeID = 2 LIMIT 1';
