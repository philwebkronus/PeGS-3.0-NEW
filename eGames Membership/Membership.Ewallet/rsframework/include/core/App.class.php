...
class App
{
     ...
     * @deprecated This method is already obsolete. Please check NewLoadClass, LoadModule, LoadModuleClass
     */
    public static function NewLoadClass($classname)
    {
     ...
     */
    public static function LoadDataClass($classname)
    {
     ...
     */
    public static function LoadCore($corefile)
    {
     ...
     */
    public static function LoadModuleClass($modulename, $classname)
    {
     ...
     */
    public static function getDBParam($paramname)
    {
        global $_DBCONF;
     ...
     * @deprecated Please use the FormsProcessor class instead
     */
    public static function GetFormValues($arrFormEntries)
    {
     ...
     */
    public static function SetStatus($statuscode, $statusmessage)
    {
     ...
     */
    public static function SetErrorMessage($errormessage, $throwexception = false, $dieonerror = false)
    {
     ...
     * @return Boolean 
     */
    public static function HasSucceeded()
    {
