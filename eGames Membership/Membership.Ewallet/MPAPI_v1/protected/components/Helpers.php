...
class Helpers
{
    ...
    public function sendEmailForgotPassword($email, $name, $hashedubcards){
        ...
        $mailer->Body .= "<br /><br /><b><a href='https://membership.egamescasino.ph/change-password/?CardNumber=$hashedubcards'>Forgot Password</a></b> ";
    ...
    public function sendEmailVerification( $email, $name, $tempcode)
    {
        ...
        $mailer->Body .= "<br />To read the Terms & Conditions, please click this link <b><a http://egamescasino.ph/terms-of-use/'>http://egamescasino.ph/terms-of-use/</a></b>.";
...
//        $logo_2u = 'logo_2u';
       // App::LoadCore("PHPMailer.class.php");
        ...
        //$filemime = 'image/jpeg';
        $mailer->AddAddress($email, $playername);
        //$mailer->AddEmbeddedImage($newheader, $filecid, $filename, $encodingtouse, $filemime);
        $mailer->IsHTML(true);
