...
//    }
   public function create_account($lname, $fname, $bdate, $salutation, $playertype, $cardnumber, $instance_url, $access_token) {
    ...
    $content = json_encode(array("FirstName" => $fname, "LastName" => $lname, "Type_of_Player__c" => $playertype, "Birthdate__c" => $bdate, "Salutation" => $salutation, "Membership_Card_Number__c" => $cardnumber, "RecordTypeId" => '01228000000JV06AAG')); //prod: '012o0000000p8uHAAQ' staging: '01228000000JV06AAG'
