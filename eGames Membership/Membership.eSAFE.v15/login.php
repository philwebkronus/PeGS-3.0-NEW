                                ...
                                <ul class="ad-thumb-list">
                                    <li>
                                        <a href="images/slider/slider_photos/1.jpg" >
                                            <img src="images/slider/slider_photos/1.jpg" title="" longdesc="images/slider/slider_photos/ConsolationPrize.jpg" alt="Caption">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="images/slider/slider_photos/2.jpg">
                                            <img src="images/slider/slider_photos/2.jpg" title="" longdesc="images/slider/slider_photos/devices.jpg" alt="">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="images/slider/slider_photos/3.jpg">
                                            <img src="images/slider/slider_photos/3.jpg" title="" longdesc="images/slider/slider_photos/MacauLuxuryTour.jpg" alt="">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="images/slider/slider_photos/4.jpg">
                                            <img src="images/slider/slider_photos/4.jpg" title="" longdesc="images/slider/slider_photos/Starcruise.jpg" alt="">
                                        </a>
                                    </li>
                                    <li>
                                        <a href="images/slider/slider_photos/5.jpg">
                                            <img src="images/slider/slider_photos/5.jpg" title="" longdesc="images/slider/slider_photos/HarleyDavidson.jpg" alt="">
                                        </a>
                                    </li>
                                </ul>
                            </div><!-- .ad-thumbs -->
