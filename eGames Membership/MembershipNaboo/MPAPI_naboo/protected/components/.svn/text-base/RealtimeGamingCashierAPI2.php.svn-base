...
class RealtimeGamingCashierAPI2
{
    ...
    public function __construct()
    {
        ...
        {
            default:
            case 4: self::__construct1($argv[0], $argv[1], $argv[2], $argv[3]);
                break;
            case 5: self::__construct2($argv[0], $argv[1], $argv[2], $argv[3], $argv[4]);
                break;
        }
    }
    ...
    public function DepositGeneric($casinoID, $PID, $methodID, $amount, $tracking1, $tracking2, $tracking3, $tracking4, $sessionID, $skinID = 1, $userID = 0)
    {
    ...
    public function WithdrawGeneric($casinoID, $PID, $methodID, $amount, $tracking1, $tracking2, $tracking3, $tracking4, $sessionID, $skinID = 1, $userID = 0)
    {
        $data = array('casinoID' => $casinoID,
            'PID' => $PID,
            'methodID' => $methodID,
