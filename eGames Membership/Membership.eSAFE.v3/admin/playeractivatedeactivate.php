    ...
    $(document).ready(function(){
        ...
        $('#btnSearch').live('click', function(){
            ...
            else
            {
                jQuery.ajax(
                {
                   url: "Helper/helper.playeractivatedeactivate.php",
                   type: 'post',
        ...
        {
            var url = "Helper/helper.playeractivatedeactivate.php";
            jQuery('#playerstatus').GridUnload();
                                ...
                                "Submit": function(){
                                    if($("#updatestatus").validationEngine("validate")){
                                        $.post("ajaxhandler.php",
                                        {
                                            ...
                                            'Method': 'terminatePlayerStatus',
                                            'MethodArgs': $("#updatestatus").serialize()
                                        },
                                        function(data){
                                            if(data != "Player Termination: Transaction Successful."){
