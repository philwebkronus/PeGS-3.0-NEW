...
$pagetitle = "Manual UB PT Assignment";
...
<script type='text/javascript'>
    ...
    $(document).ready(function() {
        ...
        function createPT(cardnumber) {
            document.getElementById('loading').style.display='block';
            document.getElementById('fade').style.display='block';
            $.ajax(
                    {
                        url: "Helper/helper.manualptcreation.php",
                        type: 'post',
                        data: {
                            pager: function() {
                                return "CreatePT";
...
<div align="center">
    <div class="maincontainer">
        <form name="playerlists" id="playerlists" method="POST">
            ...
            <br/>
            <div  style="float: left;" class="title">&nbsp;&nbsp;&nbsp;Manual UB PT Assignment</div>
