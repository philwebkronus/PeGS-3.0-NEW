...
//                                    $hours = $hours + ($diff->days*24);
    ...
    //------------------------------------------------------------------------------------------------->>>>>>>>>>>>>>>>>>>>>>>>>>>>>>>                                 
                ...
                if (empty($aid)) {
                    $transMsg = 'AccounID must not be blank';
                }
    ...
    public function actionForceLogout() {
        ...
        if ($isconnvalid == 0) {
            ...
            if (isset($data['Login']) && isset($data['SystemUsername']) && isset($data['AccessDate']) && isset($data['AccessDate'])) {
                ...
                if (!$validate->isNullOrEmpty($serviceUsername)) {
                    ...
                    if (ctype_alnum($serviceUsername)) {
                        ...
                        if (!empty($casinoDetails) && isset($casinoDetails['TerminalID']) && isset($casinoDetails['ServiceID']) && isset($casinoDetails['LoyaltyCardNumber']) && isset($casinoDetails['MID']) && isset($casinoDetails['TransactionSummaryID']) && isset($casinoDetails['UserMode'])) {
                        ...
                        if (!empty($casinoDetails) && isset($casinoDetails['TerminalID']) && isset($casinoDetails['ServiceID']) && isset($casinoDetails['LoyaltyCardNumber']) && isset($casinoDetails['MID']) && isset($casinoDetails['TransactionSummaryID']) && isset($casinoDetails['UserMode'])) {
                            ...
                            if ($siteID) {
                                ...
                                if ($AID) {
                                    ...
                                    $balances = $casinocontroller->GetBalance($casinoDetails['ServiceID'],$serviceUsername);
