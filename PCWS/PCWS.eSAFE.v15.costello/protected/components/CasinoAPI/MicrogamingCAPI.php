...
class MicrogamingCAPI
{
     ...
     * @var string
     */
    private $_URI = 'https://api18.valueactive.eu/philweb1_CAPI/CasinoAPI.aspx';
...
//        $logger->logger($message, "Request", "MG");
...
//    }
    ...
    public function ChangePassword( $loginName, $oldPassword, $newPassword )
    {
        $xmlData = array( 'Method' => array(
            ...
            'Params' => array(
                'LoginName' => array( '@attributes' => array( 'Value' => $loginName ) ),
                'OldPassword' => array( '@attributes' => array( 'Value' => $oldPassword ) ),
                'NewPassword' => array( '@attributes' => array( 'Value' => $newPassword ) )
                )
            )
        );
...
//        $logger = new CasinoLogger();
//        $logger->logger($message, "Response", "MG");
        return $object;
    }
    
        /**
     * Call this metthod to reset password of an account without supplying its old password
