...
//    }
    ...
    public function actionGetbalance(){
        ...
        $result = '';
        if(isset($_POST['CardNumber']) && isset($_POST['ServiceID']) && isset($_POST['SystemUsername']) && isset($_POST['AccessDate']) && isset($_POST['Token'])){
            $cardnumber = $_POST['CardNumber'];
            $serviceid = $_POST['ServiceID'];
            $username = $_POST['SystemUsername'];
            $syscode = empty(Yii::app()->params['SystemCode'][$username])?'':Yii::app()->params['SystemCode'][$username];
            ...
            $result = $this->_getbalance($cardnumber,$serviceid,$username,$accessdate,$tkn);
        }
        
        $this->render('getbalance', array('result'=>$result));
    }
    
    private function _getbalance($cardnumber,$serviceid,$username,$accessdate,$tkn){
        $url = Yii::app()->params['getbalance'];
        
        $postdata = CJSON::encode(array('CardNumber'=>$cardnumber,'ServiceID'=>$serviceid,'SystemUsername'=>$username, 'AccessDate'=>$accessdate, 'Token'=>$tkn));
    ...
    public function actionGetCompPoints() {
        ...
        if(isset($_POST['CardNumber']) && isset($_POST['SystemUsername']) && isset($_POST['AccessDate']) && isset($_POST['Token'])&& isset($_POST['ServiceID'])){
            $cardnumber = $_POST['CardNumber'];
            $username = $_POST['SystemUsername'];
            $syscode = empty(Yii::app()->params['SystemCode'][$username])?'':Yii::app()->params['SystemCode'][$username];
            $accessdate = $_POST['AccessDate'];
            ...
            //$tkn = sha1($dt.$syscode);
            $serviceid = $_POST['ServiceID'];
            $result = $this->_getcomppoints($cardnumber,$username,$accessdate,$tkn,$serviceid);
        }
        
        $this->render('getcomppoints', array('result'=>$result));
    }
    
    private function _getcomppoints($cardnumber,$username,$accessdate,$tkn,$serviceid){
        $url = Yii::app()->params['getcomppoints'];
        
        $postdata = CJSON::encode(array('CardNumber'=>$cardnumber,'SystemUsername'=>$username, 'AccessDate'=>$accessdate, 'Token'=>$tkn, 'ServiceID'=>$serviceid));
    ...
    public function actionDeductCompPoints() {
        ...
        if(isset($_POST['CardNumber']) && isset($_POST['Amount']) && isset($_POST['SystemUsername']) && isset($_POST['AccessDate']) && isset($_POST['Token']) && isset($_POST['ServiceID'])){
            $cardnumber = $_POST['CardNumber'];
            $amount = $_POST['Amount'];
            $siteID = $_POST['SiteID'];
            $accessdate = $_POST['AccessDate'];
            ...
            $result = $this->_deductcomppoints($siteID, $cardnumber, $amount, $username,$accessdate,$tkn  ,$serviceid);
        ...
        private function _deductcomppoints($siteID, $cardnumber, $amount, $username,$accessdate,$tkn,$serviceid ){
        $url = Yii::app()->params['deductcomppoints'];
        
        $postdata = CJSON::encode(array('CardNumber'=>$cardnumber, 'Amount'=>$amount,'SiteID'=>$siteID, 'SystemUsername'=>$username, 'AccessDate'=>$accessdate, 'Token'=>$tkn, 'ServiceID'=>$serviceid));
    ...
    public function actionForceLogout(){
        ...
        $result = '';
            ...
            if(isset($_POST['Login']) && isset($_POST['SystemUsername']) && isset($_POST['AccessDate']) && isset($_POST['Token']) && isset($_POST['ServiceID']) ){
            $username = $_POST['SystemUsername'];
            $syscode = empty(Yii::app()->params['SystemCode'][$username])?'':Yii::app()->params['SystemCode'][$username];
            $accessdate = $_POST['AccessDate'];
            //$accessdate = date('Y-m-d H:i:s');
            ...
            $serviceid = $_POST['ServiceID'];
            //$tkn = sha1($dt.$syscode);
            $result = $this->_forceLogout($_POST['Login'],$username,$accessdate,$tkn,$serviceid);
        }
        $this->render('forcelogout',array('result'=>$result));
    }
            private function _forceLogout($login, $username, $accessdate, $tkn,$serviceid){
            $uri = Yii::app()->params['forcelogout'];
            $postdata = CJSON::encode(array('Login'=>$_POST['Login'],'SystemUsername'=>$username, 'Token'=>$tkn,'AccessDate'=>$accessdate, 'ServiceID'=>$serviceid));
    ...
    public function actionForceLogoutGen(){
        ...
        if(isset($_POST['Login']) && isset($_POST['SystemUsername']) && isset($_POST['AccessDate']) && isset($_POST['Token'])&& isset($_POST['ServiceID']) ){
            ...
            $serviceid = $_POST['ServiceID'];
            //$tkn = sha1($dt.$syscode);
            $result = $this->_forceLogoutgen($_POST['Login'],$username,$accessdate,$tkn,$serviceid);
        }
        $this->render('forcelogoutgen',array('result'=>$result));
    }
    private function _forceLogoutgen($login, $username, $accessdate, $tkn,$serviceid){
        $uri = Yii::app()->params['forcelogoutgen'];
        $postdata = CJSON::encode(array('Login'=>$login,'SystemUsername'=>$username, 'AccessDate'=>$accessdate, 'Token'=>$tkn, 'ServiceID'=>$serviceid));
