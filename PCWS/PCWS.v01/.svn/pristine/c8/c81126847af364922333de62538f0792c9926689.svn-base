...
class Utilities {
   ...
   /**
     ...
     * @return string date 
     */
    public static function generateUDate($format, $utimestamp = null) {
     ...
     * @param array
     * @return first value of an array otherwise False
     */
    public static function fetchFirstValue($arr){
        $returnValue = false;
        if(!$returnValue && !empty($arr)){
