...
{
      var charCode = (evt.which) ? evt.which : evt.keyCode;
      if ((charCode >= 97 && charCode <=122)||(charCode >= 65 && charCode <=90)||(charCode>=48 && charCode<=57) || charCode==95 || charCode==8 || charCode==9)
          return true;
      else
          return false;
}
...
function chkeditsites()
{
   if(document.getElementById('cmbsiteowner').value == "-1")
   {
   ...
   else if(document.getElementById('cmbsitegrp').value == "-1")
        {
            alert("Please select site/pegs Group");
            document.getElementById('cmbsitegrp').focus();
            return false;
        }
    else if(document.getElementById('cmbislands').value == "-1")
        {
            alert("Missing Island");
            document.getElementById('cmbislands').focus();
            return false;
    ...
    else if(document.getElementById('txtsitecode').value.length == 0)
        {
            alert("Blank or Site/PEGS code with leading space/s is/are not allowed");
            document.getElementById('txtsitecode').focus();
            return false;
...
//            return false;
//        }
//    else if(document.getElementById('txtsitealias').value.length == 0)
//        {
//            alert("Please input site/pegs alias");
//            document.getElementById('txtsitealias').focus();
//            return false;
//        }
     else if(document.getElementById('txtsiteaddress').value.length == 0 || (document.getElementById('txtsiteaddress').value.indexOf(" ") == 0))
...
//     else if(document.getElementById('txtcto').value.length == 0)
//        {
...
function onchange_remittancetype()
{
    ...
    if (sRemitType == 2 || sRemitType == 5)
    {
        ...
        //document.getElementById("ddlBank").options[document.getElementById("ddlBank").selectedIndex].value = 0;
        //document.getElementById("txtBranch").value = "";
        //document.getElementById("txtBankTransID").value = "";
        //document.getElementById("txtBankTransDate").value = "";
