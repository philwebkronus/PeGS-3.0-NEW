...
//                $(event.target).parent().css('left', '20%');
        ...
        $(".cPin").click(function(){
            ...
            var isLastChanged = "<?php print $pinLastChange;?>";
            var pinDialg = "<table>";
            ...
            if(isLastChanged)
            {
                pinDialg+="<tr>"
                        +"<td>Old Pin:</td>"
                        +"<td><input type='password' id='oldPin' name='oldPin' maxlength='6'/></td>"
                        +"</tr><tr>"
                        +"<td>New Pin:</td>"
                        +"<td><input type='password' id='newPin' name='newPin' maxlength='6'/></td>"
                        +"</tr><tr>"
                        +"<td>Re-Enter New Pin:</td>"
                        +"<td><input type='password' id='reEnternewPin' name='reEnternewPin' maxlength='6'/></td>"
                        +"</tr></table>";
            ...
            $(".chngePin").html(pinDialg);
                $("#button-submit").attr('disabled',true);
                var regex = new RegExp("^[0-9\b]+$");
                //validation for changing of PIN(allowing alphanumeircs only)
                $('#oldPin').keypress(function (e) {
                ...
                $('#reEnternewPin').keypress(function (e) {
                ...
                $("#oldPin").change(function(){
                    var length = $("#oldPin").val().length;
                    if(length<6)
                    {
                        alert("Maximum of 6 number combinations");
                        $("#newPin").attr('disabled',true);
                        $("#reEnternewPin").attr('disabled',true);
                        
                    }else
                    {
                         $("#newPin").attr('disabled',false);
                         $("#reEnternewPin").attr('disabled',false);
                         
                    }
                        
                });
                $("#newPin").change(function(){
                    var length = $("#newPin").val().length;
                     if(length<6)
                    {
                        alert("Maximum of 6 number combinations");
                        $("#reEnternewPin").attr('disabled',true);
                ...
                $("#reEnternewPin").change(function(){
                    var length = $("#reEnternewPin").val().length;      
                     if(length<6)
                    {
                        alert("Maximum of 6 number combinations");
...
<script type="text/javascript">
    ...
    <div class="row-fluid">
        <div class="span4 round-gold" style="background-color: #FFF;">
                    ...
                    &nbsp;&nbsp;
                    <a class="cPin" style="color:blue;text-decoration:underline;cursor:pointer;">Change Pin</a>
                    <?php echo $btnUpdate; ?>
    ...
    <form name="SubForm" id="SubForm" method="post" action="" enctype="multipart/form-data" >
        ...
        <div id="ChangePinDialog" name="ChangePinDialog">
            <br><?php echo $hdnChangePin;?>
            <table class="chngePin"></table>
